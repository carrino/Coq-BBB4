...
| `tools/closeouttr/` | `cbt.py` (batch writer), `rw_batch.py`, `qh_batch.py`, `qc_batch.py` (lap boards inline, quiet cyclers), `ng_batch.py` (n-gram rank tier, probe + batch), `gen_closeout_tr.py`, `classes.py` |
