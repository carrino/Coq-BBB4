...
3. it is **skipped**: one of the **167** undecided core machines in
   `D_remaining` (`tools/closeout/core_rows.txt`), or one of their **80**
...
1. **The champion has no board.**  `1RB1LD_1RC1RB_1LC1LA_0RC0RD` blanks its
   ...
   currently one of the 167 core machines.  **Not done.**
2. **The 167 (+ their 80 shadows).**  Any of them could, for all this
...
> 32,779,478 or never quasihalts, except 167 still-undecided machines (and
> their 80 0RB re-root shadows) —
> kernel-checked with one standard axiom.  The BBB(4) *value* does not yet
> follow from what is here, because the champion itself is one of the 167.

## Scope of the 167

All 167 core machines are residue — machines no engine in this repository
settles, mapped by
