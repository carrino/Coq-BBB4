...
3. it is **skipped**: one of the **68** undecided core machines in
   `D_remaining` (`tools/closeout/core_rows.txt`), or one of their **22**
...
1. **The champion has no board.**  `1RB1LD_1RC1RB_1LC1LA_0RC0RD` blanks its
   ...
   currently one of the 68 core machines.  **Not done.**
...
> follow from what is here, because the champion itself is one of the 68.

## Scope of the 68

All 68 core machines are residue — machines no engine in this repository
settles, mapped by
