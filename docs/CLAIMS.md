...
1. **The 3 core machines (and the 1 shadow).**  Any of them could, for
...
decides, not merely stated.  It stays a lower bound only: closing the 3 is
...
the other 5,151 boarded rows instead of coarsening all of them to 32.8M._

So the honest one-line summary is:

> Every (4,2) machine either quasihalts with score at most the champion's
> 32,779,478 or never quasihalts, except 4 still-undecided machines (3
...
> does not follow from what is here while the 4 stand.

## Scope of the 3

All 3 core machines are residue — machines no engine in this repository
settles, mapped by
