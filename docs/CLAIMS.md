...
1. **The champion has no board.**  `1RB1LD_1RC1RB_1LC1LA_0RC0RD` blanks its
   ...
   currently one of the 427.  **Not done.**
2. **The 427.**  Any of them could, for all this development knows, be a
...
> 32,779,478 or never quasihalts, except 427 still-undecided machines —
> kernel-checked with one standard axiom.  The BBB(4) *value* does not yet
> follow from what is here, because the champion itself is one of the 427.

## Scope of the 427

All 427 are residue — machines no engine in this repository settles, mapped by
