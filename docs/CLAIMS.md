...
3. it is **skipped**: one of the **17** undecided core machines in
   ...
   `python3 tools/closeout/audit.py` prints them live.  17 + 8 is the
   2026-08-01 reading (5,131 of the frozen 5,156 settled, 99.5%)._
...
1. **The 17 core machines (and their 8 shadows).**  Any of them could, for
...
All 17 core machines are residue — machines no engine in this repository
settles, mapped by
