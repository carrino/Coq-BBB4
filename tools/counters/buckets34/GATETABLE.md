# Gate table over the 47 open core rows
...
| n | furthest gate |
|--:|---|
| 26 | `no_interior_jS_j_chain_at_octave_parity_0` |
| 10 | `no_gap_free_two_form_family` |
| 4 | `register_step_does_not_close` |
| 2 | `no_inner_family_at_pow2_j` |
| 2 | `no_inner_interior_chain` |
| 2 | `no_interior_j0_chain_at_octave_parity_0` |
| 1 | `no_boot_chain` |
