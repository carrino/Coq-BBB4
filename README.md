...
the machines the theorem **skips**: the **8 undecided core machines**
...
* The bound is **attained**: the champion `1RB1LD_1RC1RB_1LC1LA_0RC0RD`
  ...
  any of the 8 skipped core machines could, for all this development
  proves, quasihalt with a larger score.
* `skipped D_remaining tm` means membership in the orbit of the 8
