(** * LAPT_1RB0LD_0LC1RA_1LD1LC_0RB1LD: TRANSITION-LEVEL board for machine 1RB0LD_0LC1RA_1LD1LC_0RB1LD, boarded by CERTIFICATE.
...
Definition pins_1RB0LD_0LC1RA_1LD1LC_0RB1LD : list Instr := [].
Definition tmw_1RB0LD_0LC1RA_1LD1LC_0RB1LD : TM := tm_wrap_trs tmm_1RB0LD_0LC1RA_1LD1LC_0RB1LD pins_1RB0LD_0LC1RA_1LD1LC_0RB1LD.
Local Notation tm := tmw_1RB0LD_0LC1RA_1LD1LC_0RB1LD.
...
Proof.
  ...
  { unfold Cc_1RB0LD_0LC1RA_1LD1LC_0RB1LD. rewrite H2.
...
Lemma fireo_1RB0LD_0LC1RA_1LD1LC_0RB1LD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB0LD_0LC1RA_1LD1LC_0RB1LD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB0LD_0LC1RA_1LD1LC_0RB1LD p j [] []);
...
Lemma firei_1RB0LD_0LC1RA_1LD1LC_0RB1LD : forall (l : list lstep) (t : Instr),
  srun_instr tm false true l A0_1RB0LD_0LC1RA_1LD1LC_0RB1LD = Some t ->
  forall p j q0, cview p = (j, Some q0) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j q0 E.
  apply (fire_of_run_instr tm Cc false true l A0_1RB0LD_0LC1RA_1LD1LC_0RB1LD p j (Jp q0 ++ [S0]) []);
    [exact Hst | discriminate | reflexivity | exact (gsi_1RB0LD_0LC1RA_1LD1LC_0RB1LD p j q0 E)].
Qed.
...
Lemma fire_1RB0LD_0LC1RA_1LD1LC_0RB1LD : forall t, ~ In t pins_1RB0LD_0LC1RA_1LD1LC_0RB1LD ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_1RB0LD_0LC1RA_1LD1LC_0RB1LD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1]).
    vm_compute; reflexivity.
  - (* A1: fires only in the interior lap *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_int_lift tm Cc lap_1RB0LD_0LC1RA_1LD1LC_0RB1LD (StA, S1)).
    intros p1 j1 r1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (firei_1RB0LD_0LC1RA_1LD1LC_0RB1LD [SRotL 1; SWin 1; SCycL 2 0; SWin 1] (StA, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 r1 E1).
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB0LD_0LC1RA_1LD1LC_0RB1LD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 1]).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_1RB0LD_0LC1RA_1LD1LC_0RB1LD
      with (l := [SRotL 1; SWin 1]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB0LD_0LC1RA_1LD1LC_0RB1LD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 3; SCycR 2; SWin 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB0LD_0LC1RA_1LD1LC_0RB1LD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 2]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB0LD_0LC1RA_1LD1LC_0RB1LD
      with (l := []).
    vm_compute; reflexivity.
  - (* D1: fires only in the interior lap *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_int_lift tm Cc lap_1RB0LD_0LC1RA_1LD1LC_0RB1LD (StD, S1)).
    intros p1 j1 r1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (firei_1RB0LD_0LC1RA_1LD1LC_0RB1LD [SRotL 1; SWin 1; SCycL 2 0; SWin 2] (StD, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 r1 E1).
Qed.

Theorem nqhtrm_1RB0LD_0LC1RA_1LD1LC_0RB1LD : NeverQuasiHaltsTr tmm_1RB0LD_0LC1RA_1LD1LC_0RB1LD.
Proof.
  apply (glue_neverqhtr tmm_1RB0LD_0LC1RA_1LD1LC_0RB1LD pins_1RB0LD_0LC1RA_1LD1LC_0RB1LD Cc 1).
  - exact boot_1RB0LD_0LC1RA_1LD1LC_0RB1LD.
  - intros p _. apply lap_1RB0LD_0LC1RA_1LD1LC_0RB1LD.
  - intros t Ht p _. apply fire_1RB0LD_0LC1RA_1LD1LC_0RB1LD. exact Ht.
Qed.

Theorem nqhtr_1RB0LD_0LC1RA_1LD1LC_0RB1LD : NeverQuasiHaltsTr tm_1RB0LD_0LC1RA_1LD1LC_0RB1LD.
Proof. apply (neverqhtr_mirror tm_1RB0LD_0LC1RA_1LD1LC_0RB1LD). rewrite mirror_ok_1RB0LD_0LC1RA_1LD1LC_0RB1LD. exact nqhtrm_1RB0LD_0LC1RA_1LD1LC_0RB1LD. Qed.

Theorem nonhalt_1RB0LD_0LC1RA_1LD1LC_0RB1LD : NonHalt tm_1RB0LD_0LC1RA_1LD1LC_0RB1LD.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB0LD_0LC1RA_1LD1LC_0RB1LD. Qed.
