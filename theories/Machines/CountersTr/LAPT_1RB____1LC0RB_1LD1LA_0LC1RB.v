(** * LAPT_1RB____1LC0RB_1LD1LA_0LC1RB: TRANSITION-LEVEL board for machine 1RB---_1LC0RB_1LD1LA_0LC1RB, boarded by CERTIFICATE.
...
Definition pins_1RB____1LC0RB_1LD1LA_0LC1RB : list Instr := [(StA, S1)].
Definition tmw_1RB____1LC0RB_1LD1LA_0LC1RB : TM := tm_wrap_trs tmm_1RB____1LC0RB_1LD1LA_0LC1RB pins_1RB____1LC0RB_1LD1LA_0LC1RB.
Local Notation tm := tmw_1RB____1LC0RB_1LD1LA_0LC1RB.
...
Definition Cc_1RB____1LC0RB_1LD1LA_0LC1RB (p : positive) : cconf := (StB, (Ap_Alph_10_11_11 p ++ [S0], S0, [S0;S1])).
...
Lemma gsi_1RB____1LC0RB_1LD1LA_0LC1RB : forall p j q0, cview p = (j, Some q0) ->
  Cc p = cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A0_1RB____1LC0RB_1LD1LA_0LC1RB.
Proof.
...
Lemma gei_1RB____1LC0RB_1LD1LA_0LC1RB : forall p j q0, cview p = (j, Some q0) ->
  cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A1_1RB____1LC0RB_1LD1LA_0LC1RB = Cc (Pos.succ p).
Proof.
...
Proof.
  ...
  rewrite (srun_sound tm false true chi_1RB____1LC0RB_1LD1LA_0LC1RB A0_1RB____1LC0RB_1LD1LA_0LC1RB A1_1RB____1LC0RB_1LD1LA_0LC1RB 4 12
             run_int_1RB____1LC0RB_1LD1LA_0LC1RB (Ap_Alph_10_11_11 q0 ++ [S0]) [] j
...
Proof.
  ...
  { unfold Cc_1RB____1LC0RB_1LD1LA_0LC1RB. rewrite H2.
...
Lemma fireo_1RB____1LC0RB_1LD1LA_0LC1RB : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB____1LC0RB_1LD1LA_0LC1RB = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB____1LC0RB_1LD1LA_0LC1RB p j [] []);
...
Lemma fire_1RB____1LC0RB_1LD1LA_0LC1RB : forall t, ~ In t pins_1RB____1LC0RB_1LD1LA_0LC1RB ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_1RB____1LC0RB_1LD1LA_0LC1RB
      with (l := [SWin 4; SCycL 2 0; SWin 6; SCycR 2; SWin 2; SWinR 1]).
    vm_compute; reflexivity.
  - (* A1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB____1LC0RB_1LD1LA_0LC1RB
      with (l := []).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_1RB____1LC0RB_1LD1LA_0LC1RB
      with (l := [SWin 3]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB____1LC0RB_1LD1LA_0LC1RB
      with (l := [SWin 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB____1LC0RB_1LD1LA_0LC1RB
      with (l := [SWin 4; SCycL 2 0; SWin 6; SCycR 2; SWin 2]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB____1LC0RB_1LD1LA_0LC1RB
      with (l := [SWin 4; SCycL 2 0; SWin 5]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB____1LC0RB_1LD1LA_0LC1RB
      with (l := [SWin 2]).
    vm_compute; reflexivity.
Qed.

Theorem nqhtrm_1RB____1LC0RB_1LD1LA_0LC1RB : NeverQuasiHaltsTr tmm_1RB____1LC0RB_1LD1LA_0LC1RB.
Proof.
  apply (glue_neverqhtr tmm_1RB____1LC0RB_1LD1LA_0LC1RB pins_1RB____1LC0RB_1LD1LA_0LC1RB Cc 1).
  - exact boot_1RB____1LC0RB_1LD1LA_0LC1RB.
  - intros p _. apply lap_1RB____1LC0RB_1LD1LA_0LC1RB.
  - intros t Ht p _. apply fire_1RB____1LC0RB_1LD1LA_0LC1RB. exact Ht.
Qed.

Theorem nqhtr_1RB____1LC0RB_1LD1LA_0LC1RB : NeverQuasiHaltsTr tm_1RB____1LC0RB_1LD1LA_0LC1RB.
Proof. apply (neverqhtr_mirror tm_1RB____1LC0RB_1LD1LA_0LC1RB). rewrite mirror_ok_1RB____1LC0RB_1LD1LA_0LC1RB. exact nqhtrm_1RB____1LC0RB_1LD1LA_0LC1RB. Qed.

Theorem nonhalt_1RB____1LC0RB_1LD1LA_0LC1RB : NonHalt tm_1RB____1LC0RB_1LD1LA_0LC1RB.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB____1LC0RB_1LD1LA_0LC1RB. Qed.
