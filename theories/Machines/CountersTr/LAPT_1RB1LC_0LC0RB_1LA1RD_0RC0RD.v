(** * LAPT_1RB1LC_0LC0RB_1LA1RD_0RC0RD: TRANSITION-LEVEL board for machine 1RB1LC_0LC0RB_1LA1RD_0RC0RD, boarded by CERTIFICATE.
...
Definition pins_1RB1LC_0LC0RB_1LA1RD_0RC0RD : list Instr := [].
Definition tmw_1RB1LC_0LC0RB_1LA1RD_0RC0RD : TM := tm_wrap_trs tm_1RB1LC_0LC0RB_1LA1RD_0RC0RD pins_1RB1LC_0LC0RB_1LA1RD_0RC0RD.
Local Notation tm := tmw_1RB1LC_0LC0RB_1LA1RD_0RC0RD.
...
Lemma fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB1LC_0LC0RB_1LA1RD_0RC0RD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB1LC_0LC0RB_1LA1RD_0RC0RD p j [] []);
...
Lemma fire_1RB1LC_0LC0RB_1LA1RD_0RC0RD : forall t, ~ In t pins_1RB1LC_0LC0RB_1LA1RD_0RC0RD ->
...
Proof.
  ...
  - (* A0 *)
    ...
    apply (fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD [] (StA, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* A1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StA, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD [SWin 1; SWinR 3] (StA, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD [SWin 1; SWinR 1] (StB, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD [SWin 1] (StB, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD [SWin 1; SWinR 2] (StC, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD [SWin 1; SWinR 3; SCycL 2 0; SWin 1] (StC, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD [SWin 1; SWinR 3; SCycL 2 0; SWin 2; SCycR 2; SWin 2] (StD, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_0LC0RB_1LA1RD_0RC0RD [SWin 1; SWinR 3; SCycL 2 0; SWin 2] (StD, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
Qed.

Theorem nqhtr_1RB1LC_0LC0RB_1LA1RD_0RC0RD : NeverQuasiHaltsTr tm_1RB1LC_0LC0RB_1LA1RD_0RC0RD.
Proof.
  apply (glue_neverqhtr tm_1RB1LC_0LC0RB_1LA1RD_0RC0RD pins_1RB1LC_0LC0RB_1LA1RD_0RC0RD Cc 1).
  - exact boot_1RB1LC_0LC0RB_1LA1RD_0RC0RD.
  - intros p _. apply lap_1RB1LC_0LC0RB_1LA1RD_0RC0RD.
  - intros t Ht p _. apply fire_1RB1LC_0LC0RB_1LA1RD_0RC0RD. exact Ht.
Qed.

Theorem nonhalt_1RB1LC_0LC0RB_1LA1RD_0RC0RD : NonHalt tm_1RB1LC_0LC0RB_1LA1RD_0RC0RD.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB1LC_0LC0RB_1LA1RD_0RC0RD. Qed.
