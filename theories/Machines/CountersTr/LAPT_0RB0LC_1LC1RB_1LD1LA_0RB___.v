(** * LAPT_0RB0LC_1LC1RB_1LD1LA_0RB___: TRANSITION-LEVEL board for machine 0RB0LC_1LC1RB_1LD1LA_0RB---, boarded by CERTIFICATE.
...
Definition pins_0RB0LC_1LC1RB_1LD1LA_0RB___ : list Instr := [(StD, S1)].
Definition tmw_0RB0LC_1LC1RB_1LD1LA_0RB___ : TM := tm_wrap_trs tmm_0RB0LC_1LC1RB_1LD1LA_0RB___ pins_0RB0LC_1LC1RB_1LD1LA_0RB___.
Local Notation tm := tmw_0RB0LC_1LC1RB_1LD1LA_0RB___.
...
Lemma fireo_0RB0LC_1LC1RB_1LD1LA_0RB___ : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_0RB0LC_1LC1RB_1LD1LA_0RB___ = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_0RB0LC_1LC1RB_1LD1LA_0RB___ p j [] []);
...
Lemma fire_0RB0LC_1LC1RB_1LD1LA_0RB___ : forall t, ~ In t pins_0RB0LC_1LC1RB_1LD1LA_0RB___ ->
...
Proof.
  ...
  - (* A0 *)
    ...
    apply (fireo_0RB0LC_1LC1RB_1LD1LA_0RB___ [SWin 1; SWinR 1] (StA, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* A1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StA, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB0LC_1LC1RB_1LD1LA_0RB___ [SWin 1; SWinR 3; SCycL 2 0; SWin 5] (StA, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB0LC_1LC1RB_1LD1LA_0RB___ [] (StB, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB0LC_1LC1RB_1LD1LA_0RB___ [SWin 1; SWinR 2] (StB, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB0LC_1LC1RB_1LD1LA_0RB___ [SWin 1; SWinR 3; SCycL 2 0; SWin 6; SCycR 2; SWin 2] (StC, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB0LC_1LC1RB_1LD1LA_0RB___ [SWin 1] (StC, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB0LC_1LC1RB_1LD1LA_0RB___ [SWin 1; SWinR 3; SCycL 2 0; SWin 6; SCycR 2; SWin 2; SWinR 1] (StD, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
Qed.

Theorem nqhtrm_0RB0LC_1LC1RB_1LD1LA_0RB___ : NeverQuasiHaltsTr tmm_0RB0LC_1LC1RB_1LD1LA_0RB___.
Proof.
  apply (glue_neverqhtr tmm_0RB0LC_1LC1RB_1LD1LA_0RB___ pins_0RB0LC_1LC1RB_1LD1LA_0RB___ Cc 1).
  - exact boot_0RB0LC_1LC1RB_1LD1LA_0RB___.
  - intros p _. apply lap_0RB0LC_1LC1RB_1LD1LA_0RB___.
  - intros t Ht p _. apply fire_0RB0LC_1LC1RB_1LD1LA_0RB___. exact Ht.
Qed.

Theorem nqhtr_0RB0LC_1LC1RB_1LD1LA_0RB___ : NeverQuasiHaltsTr tm_0RB0LC_1LC1RB_1LD1LA_0RB___.
Proof. apply (neverqhtr_mirror tm_0RB0LC_1LC1RB_1LD1LA_0RB___). rewrite mirror_ok_0RB0LC_1LC1RB_1LD1LA_0RB___. exact nqhtrm_0RB0LC_1LC1RB_1LD1LA_0RB___. Qed.

Theorem nonhalt_0RB0LC_1LC1RB_1LD1LA_0RB___ : NonHalt tm_0RB0LC_1LC1RB_1LD1LA_0RB___.
Proof. apply never_qh_tr_nonhalt, nqhtr_0RB0LC_1LC1RB_1LD1LA_0RB___. Qed.
