(** * LAPQ_1RB1LC_1LA____1RD0LC_0RD1LC: TRANSITION-LEVEL QUASIHALTING-side board for machine 1RB1LC_1LA---_1RD0LC_0RD1LC, boarded by CERTIFICATE.
...
Definition pins_1RB1LC_1LA____1RD0LC_0RD1LC : list Instr := [(StB, S1); (StA, S0); (StA, S1); (StB, S0)].
Definition tmw_1RB1LC_1LA____1RD0LC_0RD1LC : TM := tm_wrap_trs tm_1RB1LC_1LA____1RD0LC_0RD1LC pins_1RB1LC_1LA____1RD0LC_0RD1LC.
Local Notation tm := tmw_1RB1LC_1LA____1RD0LC_0RD1LC.
...
Lemma bootq_1RB1LC_1LA____1RD0LC_0RD1LC : stepn tm_1RB1LC_1LA____1RD0LC_0RD1LC 7 InitES = Some (lift (Cc 1)).
Proof.
  assert (H : match csteps tm_1RB1LC_1LA____1RD0LC_0RD1LC 7 c0 with
              | Some c => ceqb c (Cc 1) | None => false end = true)
    by (vm_compute; reflexivity).
  destruct (csteps tm_1RB1LC_1LA____1RD0LC_0RD1LC 7 c0) as [c|] eqn:E; [|discriminate].
  rewrite <- lift_c0, (csteps_lift _ _ _ _ E). f_equal. apply ceqb_lift. exact H.
Qed.

(** the quasihalt witness: a pinned instruction fired in the prefix *)
Lemma wit_1RB1LC_1LA____1RD0LC_0RD1LC : existsb (fun tg => cfires tm_1RB1LC_1LA____1RD0LC_0RD1LC c0 7 tg) pins_1RB1LC_1LA____1RD0LC_0RD1LC = true.
Proof. vm_compute. reflexivity. Qed.
...
Lemma fireo_1RB1LC_1LA____1RD0LC_0RD1LC : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB1LC_1LA____1RD0LC_0RD1LC = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB1LC_1LA____1RD0LC_0RD1LC p j [] []);
...
Lemma fire_1RB1LC_1LA____1RD0LC_0RD1LC : forall t, ~ In t pins_1RB1LC_1LA____1RD0LC_0RD1LC ->
...
Proof.
  ...
  - (* B1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB1LC_1LA____1RD0LC_0RD1LC
      with (l := [SWin 2]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB1LC_1LA____1RD0LC_0RD1LC
      with (l := [SWin 4]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB1LC_1LA____1RD0LC_0RD1LC
      with (l := []).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB1LC_1LA____1RD0LC_0RD1LC
      with (l := [SWin 1]).
    vm_compute; reflexivity.
Qed.

Theorem qhtr_1RB1LC_1LA____1RD0LC_0RD1LC : NonHalt tm_1RB1LC_1LA____1RD0LC_0RD1LC /\ QHBoundTr 32779478 tm_1RB1LC_1LA____1RD0LC_0RD1LC /\ QuasiHaltsTr tm_1RB1LC_1LA____1RD0LC_0RD1LC.
Proof.
  apply (lap_qh_stage tm_1RB1LC_1LA____1RD0LC_0RD1LC pins_1RB1LC_1LA____1RD0LC_0RD1LC Cc 1 7 32779478).
  - exact bootq_1RB1LC_1LA____1RD0LC_0RD1LC.
  - intros p _. apply lap_1RB1LC_1LA____1RD0LC_0RD1LC.
  - intros t Ht p _. apply fire_1RB1LC_1LA____1RD0LC_0RD1LC. exact Ht.
  - exact wit_1RB1LC_1LA____1RD0LC_0RD1LC.
