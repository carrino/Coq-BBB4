(** * LAPT_1RB1RD_0LC1LA_1LB1RD_1LC0RD: TRANSITION-LEVEL board for machine 1RB1RD_0LC1LA_1LB1RD_1LC0RD, boarded by CERTIFICATE.

    Auto-emitted by tools/counters/emit_lapcert.py (UNTRUSTED emitter; the Coq
    kernel re-runs the checker on every line below).  Left-growth binary
    counter under the Ap_Alph_10_11_11 digit alphabet (Alph_10_11_11.v), anchored at

      Cc p = (StD, (Ap_Alph_10_11_11 p ++ [S0], S0, [S0;S0;S1]))
...
Definition pins_1RB1RD_0LC1LA_1LB1RD_1LC0RD : list Instr := [].
Definition tmw_1RB1RD_0LC1LA_1LB1RD_1LC0RD : TM := tm_wrap_trs tmm_1RB1RD_0LC1LA_1LB1RD_1LC0RD pins_1RB1RD_0LC1LA_1LB1RD_1LC0RD.
Local Notation tm := tmw_1RB1RD_0LC1LA_1LB1RD_1LC0RD.
...
Definition Cc_1RB1RD_0LC1LA_1LB1RD_1LC0RD (p : positive) : cconf := (StD, (Ap_Alph_10_11_11 p ++ [S0], S0, [S0;S0;S1])).
...
Lemma gsi_1RB1RD_0LC1LA_1LB1RD_1LC0RD : forall p j q0, cview p = (j, Some q0) ->
  Cc p = cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A0_1RB1RD_0LC1LA_1LB1RD_1LC0RD.
Proof.
...
Lemma gei_1RB1RD_0LC1LA_1LB1RD_1LC0RD : forall p j q0, cview p = (j, Some q0) ->
  cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A1_1RB1RD_0LC1LA_1LB1RD_1LC0RD = Cc (Pos.succ p).
Proof.
...
Proof.
  ...
  rewrite (srun_sound tm false true chi_1RB1RD_0LC1LA_1LB1RD_1LC0RD A0_1RB1RD_0LC1LA_1LB1RD_1LC0RD A1_1RB1RD_0LC1LA_1LB1RD_1LC0RD 4 20
             run_int_1RB1RD_0LC1LA_1LB1RD_1LC0RD (Ap_Alph_10_11_11 q0 ++ [S0]) [] j
...
Proof.
  ...
  { unfold Cc_1RB1RD_0LC1LA_1LB1RD_1LC0RD. rewrite H2.
...
Lemma fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB1RD_0LC1LA_1LB1RD_1LC0RD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB1RD_0LC1LA_1LB1RD_1LC0RD p j [] []);
...
Lemma fire_1RB1RD_0LC1LA_1LB1RD_1LC0RD : forall t, ~ In t pins_1RB1RD_0LC1LA_1LB1RD_1LC0RD ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD
      with (l := [SWin 8; SCycL 2 0; SWin 6; SCycR 2; SWin 3; SWinR 1]).
    vm_compute; reflexivity.
  - (* A1 *)
    apply (fire_via_ovf tm Cc Hi (StA, S1)), fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD
      with (l := [SWin 8; SCycL 2 0; SWin 6; SCycR 2; SWin 3; SWinR 3]).
    vm_compute; reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD
      with (l := [SWin 2]).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD
      with (l := [SWin 8; SCycL 2 0; SWin 6; SCycR 2; SWin 3]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD
      with (l := [SWin 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD
      with (l := [SWin 3]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD
      with (l := []).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB1RD_0LC1LA_1LB1RD_1LC0RD
      with (l := [SWin 6]).
    vm_compute; reflexivity.
Qed.

Theorem nqhtrm_1RB1RD_0LC1LA_1LB1RD_1LC0RD : NeverQuasiHaltsTr tmm_1RB1RD_0LC1LA_1LB1RD_1LC0RD.
Proof.
  apply (glue_neverqhtr tmm_1RB1RD_0LC1LA_1LB1RD_1LC0RD pins_1RB1RD_0LC1LA_1LB1RD_1LC0RD Cc 1).
  - exact boot_1RB1RD_0LC1LA_1LB1RD_1LC0RD.
  - intros p _. apply lap_1RB1RD_0LC1LA_1LB1RD_1LC0RD.
  - intros t Ht p _. apply fire_1RB1RD_0LC1LA_1LB1RD_1LC0RD. exact Ht.
Qed.

Theorem nqhtr_1RB1RD_0LC1LA_1LB1RD_1LC0RD : NeverQuasiHaltsTr tm_1RB1RD_0LC1LA_1LB1RD_1LC0RD.
Proof. apply (neverqhtr_mirror tm_1RB1RD_0LC1LA_1LB1RD_1LC0RD). rewrite mirror_ok_1RB1RD_0LC1LA_1LB1RD_1LC0RD. exact nqhtrm_1RB1RD_0LC1LA_1LB1RD_1LC0RD. Qed.

Theorem nonhalt_1RB1RD_0LC1LA_1LB1RD_1LC0RD : NonHalt tm_1RB1RD_0LC1LA_1LB1RD_1LC0RD.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB1RD_0LC1LA_1LB1RD_1LC0RD. Qed.
