(** * LAPT_1RB1RC_1LC0RD_1LA1LB_0LC1RD: TRANSITION-LEVEL board for machine 1RB1RC_1LC0RD_1LA1LB_0LC1RD, boarded by CERTIFICATE.
...
Definition pins_1RB1RC_1LC0RD_1LA1LB_0LC1RD : list Instr := [].
Definition tmw_1RB1RC_1LC0RD_1LA1LB_0LC1RD : TM := tm_wrap_trs tm_1RB1RC_1LC0RD_1LA1LB_0LC1RD pins_1RB1RC_1LC0RD_1LA1LB_0LC1RD.
Local Notation tm := tmw_1RB1RC_1LC0RD_1LA1LB_0LC1RD.
...
Lemma fireo_1RB1RC_1LC0RD_1LA1LB_0LC1RD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB1RC_1LC0RD_1LA1LB_0LC1RD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB1RC_1LC0RD_1LA1LB_0LC1RD p j [] []);
...
Lemma firex_1RB1RC_1LC0RD_1LA1LB_0LC1RD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l BE0_1RB1RC_1LC0RD_1LA1LB_0LC1RD = Some t ->
  forall p j, cview p = (S j, None) ->
...
Proof.
  ...
  apply (fire_via_fill tm Cc Cin2 lapin2_1RB1RC_1LC0RD_1LA1LB_0LC1RD t p (pow2 j));
  ...
  apply (fire_of_run_instr tm (fun _ : positive => Cin2 (fill (pow2 j)))
                    true true l BE0_1RB1RC_1LC0RD_1LA1LB_0LC1RD xH j [] []);
    [exact Hst | reflexivity | reflexivity | exact (gxi2_1RB1RC_1LC0RD_1LA1LB_0LC1RD j)].
Qed.
...
Lemma fire_1RB1RC_1LC0RD_1LA1LB_0LC1RD : forall t, ~ In t pins_1RB1RC_1LC0RD_1LA1LB_0LC1RD ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_1RB1RC_1LC0RD_1LA1LB_0LC1RD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 2]).
    vm_compute; reflexivity.
  - (* A1: fires in the exit half of the overflow *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc lapil_1RB1RC_1LC0RD_1LA1LB_0LC1RD (StA, S1)).
    intros p1 j1 E1.
    exact (firex_1RB1RC_1LC0RD_1LA1LB_0LC1RD [SRotL 1; SWin 1; SCycL 2 0; SWin 3] (StA, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB1RC_1LC0RD_1LA1LB_0LC1RD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1]).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_1RB1RC_1LC0RD_1LA1LB_0LC1RD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 3]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB1RC_1LC0RD_1LA1LB_0LC1RD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB1RC_1LC0RD_1LA1LB_0LC1RD
      with (l := [SRotL 1; SWin 1]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB1RC_1LC0RD_1LA1LB_0LC1RD
      with (l := []).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB1RC_1LC0RD_1LA1LB_0LC1RD
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 4]).
    vm_compute; reflexivity.
Qed.

Theorem nqhtr_1RB1RC_1LC0RD_1LA1LB_0LC1RD : NeverQuasiHaltsTr tm_1RB1RC_1LC0RD_1LA1LB_0LC1RD.
Proof.
  apply (glue_neverqhtr tm_1RB1RC_1LC0RD_1LA1LB_0LC1RD pins_1RB1RC_1LC0RD_1LA1LB_0LC1RD Cc 6).
  - exact boot_1RB1RC_1LC0RD_1LA1LB_0LC1RD.
  - intros p _. apply lap_1RB1RC_1LC0RD_1LA1LB_0LC1RD.
  - intros t Ht p _. apply fire_1RB1RC_1LC0RD_1LA1LB_0LC1RD. exact Ht.
Qed.

Theorem nonhalt_1RB1RC_1LC0RD_1LA1LB_0LC1RD : NonHalt tm_1RB1RC_1LC0RD_1LA1LB_0LC1RD.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB1RC_1LC0RD_1LA1LB_0LC1RD. Qed.
