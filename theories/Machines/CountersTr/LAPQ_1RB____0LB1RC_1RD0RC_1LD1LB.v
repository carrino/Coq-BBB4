(** * LAPQ_1RB____0LB1RC_1RD0RC_1LD1LB: TRANSITION-LEVEL QUASIHALTING-side board for machine 1RB---_0LB1RC_1RD0RC_1LD1LB, boarded by CERTIFICATE.
...
Definition pins_1RB____0LB1RC_1RD0RC_1LD1LB : list Instr := [(StA, S1); (StA, S0)].
Definition tmw_1RB____0LB1RC_1RD0RC_1LD1LB : TM := tm_wrap_trs tmm_1RB____0LB1RC_1RD0RC_1LD1LB pins_1RB____0LB1RC_1RD0RC_1LD1LB.
Local Notation tm := tmw_1RB____0LB1RC_1RD0RC_1LD1LB.
...
Lemma bootq_1RB____0LB1RC_1RD0RC_1LD1LB : stepn tmm_1RB____0LB1RC_1RD0RC_1LD1LB 12 InitES = Some (lift (Cc 1)).
Proof.
  assert (H : match csteps tmm_1RB____0LB1RC_1RD0RC_1LD1LB 12 c0 with
              | Some c => ceqb c (Cc 1) | None => false end = true)
    by (vm_compute; reflexivity).
  destruct (csteps tmm_1RB____0LB1RC_1RD0RC_1LD1LB 12 c0) as [c|] eqn:E; [|discriminate].
  rewrite <- lift_c0, (csteps_lift _ _ _ _ E). f_equal. apply ceqb_lift. exact H.
Qed.

(** the quasihalt witness: a pinned instruction fired in the prefix *)
Lemma wit_1RB____0LB1RC_1RD0RC_1LD1LB : existsb (fun tg => cfires tmm_1RB____0LB1RC_1RD0RC_1LD1LB c0 12 tg) pins_1RB____0LB1RC_1RD0RC_1LD1LB = true.
Proof. vm_compute. reflexivity. Qed.
...
Lemma fireo_1RB____0LB1RC_1RD0RC_1LD1LB : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB____0LB1RC_1RD0RC_1LD1LB = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB____0LB1RC_1RD0RC_1LD1LB p j [] []);
...
Lemma fire_1RB____0LB1RC_1RD0RC_1LD1LB : forall t, ~ In t pins_1RB____0LB1RC_1RD0RC_1LD1LB ->
...
Proof.
  ...
  - (* A1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB____0LB1RC_1RD0RC_1LD1LB
      with (l := []).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_1RB____0LB1RC_1RD0RC_1LD1LB
      with (l := [SWin 2]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB____0LB1RC_1RD0RC_1LD1LB
      with (l := [SWin 3]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB____0LB1RC_1RD0RC_1LD1LB
      with (l := [SWin 7]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB____0LB1RC_1RD0RC_1LD1LB
      with (l := [SWin 4]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB____0LB1RC_1RD0RC_1LD1LB
      with (l := [SWin 5]).
    vm_compute; reflexivity.
Qed.

Theorem qhtrm_1RB____0LB1RC_1RD0RC_1LD1LB : NonHalt tmm_1RB____0LB1RC_1RD0RC_1LD1LB /\ QHBoundTr 32779478 tmm_1RB____0LB1RC_1RD0RC_1LD1LB /\ QuasiHaltsTr tmm_1RB____0LB1RC_1RD0RC_1LD1LB.
Proof.
  apply (lap_qh_stage tmm_1RB____0LB1RC_1RD0RC_1LD1LB pins_1RB____0LB1RC_1RD0RC_1LD1LB Cc 1 12 32779478).
  - exact bootq_1RB____0LB1RC_1RD0RC_1LD1LB.
  - intros p _. apply lap_1RB____0LB1RC_1RD0RC_1LD1LB.
  - intros t Ht p _. apply fire_1RB____0LB1RC_1RD0RC_1LD1LB. exact Ht.
  - exact wit_1RB____0LB1RC_1RD0RC_1LD1LB.
  - vm_cast_no_check (eq_refl true).
Qed.

Theorem qhtr_1RB____0LB1RC_1RD0RC_1LD1LB : NonHalt tm_1RB____0LB1RC_1RD0RC_1LD1LB /\ QHBoundTr 32779478 tm_1RB____0LB1RC_1RD0RC_1LD1LB /\ QuasiHaltsTr tm_1RB____0LB1RC_1RD0RC_1LD1LB.
Proof. apply (qh_triple_unmirror 32779478 tm_1RB____0LB1RC_1RD0RC_1LD1LB). rewrite mirror_ok_1RB____0LB1RC_1RD0RC_1LD1LB. exact qhtrm_1RB____0LB1RC_1RD0RC_1LD1LB. Qed.
