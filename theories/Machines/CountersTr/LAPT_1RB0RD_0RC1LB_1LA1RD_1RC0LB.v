(** * LAPT_1RB0RD_0RC1LB_1LA1RD_1RC0LB: TRANSITION-LEVEL board for machine 1RB0RD_0RC1LB_1LA1RD_1RC0LB, boarded by CERTIFICATE.
...
Definition pins_1RB0RD_0RC1LB_1LA1RD_1RC0LB : list Instr := [].
Definition tmw_1RB0RD_0RC1LB_1LA1RD_1RC0LB : TM := tm_wrap_trs tmm_1RB0RD_0RC1LB_1LA1RD_1RC0LB pins_1RB0RD_0RC1LB_1LA1RD_1RC0LB.
Local Notation tm := tmw_1RB0RD_0RC1LB_1LA1RD_1RC0LB.
...
Proof.
  ...
  { unfold Cc_1RB0RD_0RC1LB_1LA1RD_1RC0LB. rewrite H2.
...
Lemma fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB0RD_0RC1LB_1LA1RD_1RC0LB = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB0RD_0RC1LB_1LA1RD_1RC0LB p j [] []);
...
Lemma fire_1RB0RD_0RC1LB_1LA1RD_1RC0LB : forall t, ~ In t pins_1RB0RD_0RC1LB_1LA1RD_1RC0LB ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 6]).
    vm_compute; reflexivity.
  - (* A1 *)
    apply (fire_via_ovf tm Cc Hi (StA, S1)), fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 2]).
    vm_compute; reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB
      with (l := []).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 7]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB
      with (l := [SRotL 1; SWin 1]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB0RD_0RC1LB_1LA1RD_1RC0LB
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 3]).
    vm_compute; reflexivity.
Qed.

Theorem nqhtrm_1RB0RD_0RC1LB_1LA1RD_1RC0LB : NeverQuasiHaltsTr tmm_1RB0RD_0RC1LB_1LA1RD_1RC0LB.
Proof.
  apply (glue_neverqhtr tmm_1RB0RD_0RC1LB_1LA1RD_1RC0LB pins_1RB0RD_0RC1LB_1LA1RD_1RC0LB Cc 2).
  - exact boot_1RB0RD_0RC1LB_1LA1RD_1RC0LB.
  - intros p _. apply lap_1RB0RD_0RC1LB_1LA1RD_1RC0LB.
  - intros t Ht p _. apply fire_1RB0RD_0RC1LB_1LA1RD_1RC0LB. exact Ht.
Qed.

Theorem nqhtr_1RB0RD_0RC1LB_1LA1RD_1RC0LB : NeverQuasiHaltsTr tm_1RB0RD_0RC1LB_1LA1RD_1RC0LB.
Proof. apply (neverqhtr_mirror tm_1RB0RD_0RC1LB_1LA1RD_1RC0LB). rewrite mirror_ok_1RB0RD_0RC1LB_1LA1RD_1RC0LB. exact nqhtrm_1RB0RD_0RC1LB_1LA1RD_1RC0LB. Qed.

Theorem nonhalt_1RB0RD_0RC1LB_1LA1RD_1RC0LB : NonHalt tm_1RB0RD_0RC1LB_1LA1RD_1RC0LB.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB0RD_0RC1LB_1LA1RD_1RC0LB. Qed.
