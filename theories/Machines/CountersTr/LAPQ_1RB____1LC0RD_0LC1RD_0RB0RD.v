(** * LAPQ_1RB____1LC0RD_0LC1RD_0RB0RD: TRANSITION-LEVEL QUASIHALTING-side board for machine 1RB---_1LC0RD_0LC1RD_0RB0RD, boarded by CERTIFICATE.

    Auto-emitted by tools/counters/emit_lapcert.py (UNTRUSTED emitter; the Coq
    kernel re-runs the checker on every line below).  Left-growth binary
    counter under the Ap_Alph_00_01_1 digit alphabet (Alph_00_01_1.v), anchored at

      Cc p = (StB, (Ap_Alph_00_01_1 p ++ [S0], S0, [S0;S1]))
...
Definition pins_1RB____1LC0RD_0LC1RD_0RB0RD : list Instr := [(StA, S1); (StA, S0)].
Definition tmw_1RB____1LC0RD_0LC1RD_0RB0RD : TM := tm_wrap_trs tmm_1RB____1LC0RD_0LC1RD_0RB0RD pins_1RB____1LC0RD_0LC1RD_0RB0RD.
Local Notation tm := tmw_1RB____1LC0RD_0LC1RD_0RB0RD.
...
Lemma bootq_1RB____1LC0RD_0LC1RD_0RB0RD : stepn tmm_1RB____1LC0RD_0LC1RD_0RB0RD 10 InitES = Some (lift (Cc 1)).
Proof.
  assert (H : match csteps tmm_1RB____1LC0RD_0LC1RD_0RB0RD 10 c0 with
              | Some c => ceqb c (Cc 1) | None => false end = true)
    by (vm_compute; reflexivity).
  destruct (csteps tmm_1RB____1LC0RD_0LC1RD_0RB0RD 10 c0) as [c|] eqn:E; [|discriminate].
  rewrite <- lift_c0, (csteps_lift _ _ _ _ E). f_equal. apply ceqb_lift. exact H.
Qed.

(** the quasihalt witness: a pinned instruction fired in the prefix *)
Lemma wit_1RB____1LC0RD_0LC1RD_0RB0RD : existsb (fun tg => cfires tmm_1RB____1LC0RD_0LC1RD_0RB0RD c0 10 tg) pins_1RB____1LC0RD_0LC1RD_0RB0RD = true.
Proof. vm_compute. reflexivity. Qed.
...
Lemma fireo_1RB____1LC0RD_0LC1RD_0RB0RD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB____1LC0RD_0LC1RD_0RB0RD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB____1LC0RD_0LC1RD_0RB0RD p j [] []);
...
Lemma fire_1RB____1LC0RD_0LC1RD_0RB0RD : forall t, ~ In t pins_1RB____1LC0RD_0LC1RD_0RB0RD ->
...
Proof.
  ...
  - (* A1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB____1LC0RD_0LC1RD_0RB0RD
      with (l := []).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_1RB____1LC0RD_0LC1RD_0RB0RD
      with (l := [SWin 4]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB____1LC0RD_0LC1RD_0RB0RD
      with (l := [SWin 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB____1LC0RD_0LC1RD_0RB0RD
      with (l := [SWin 2]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB____1LC0RD_0LC1RD_0RB0RD
      with (l := [SWin 3]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB____1LC0RD_0LC1RD_0RB0RD
      with (l := [SWin 4; SCycL 2 0; SWin 1]).
    vm_compute; reflexivity.
Qed.

Theorem qhtrm_1RB____1LC0RD_0LC1RD_0RB0RD : NonHalt tmm_1RB____1LC0RD_0LC1RD_0RB0RD /\ QHBoundTr 32779478 tmm_1RB____1LC0RD_0LC1RD_0RB0RD /\ QuasiHaltsTr tmm_1RB____1LC0RD_0LC1RD_0RB0RD.
Proof.
  apply (lap_qh_stage tmm_1RB____1LC0RD_0LC1RD_0RB0RD pins_1RB____1LC0RD_0LC1RD_0RB0RD Cc 1 10 32779478).
  - exact bootq_1RB____1LC0RD_0LC1RD_0RB0RD.
  - intros p _. apply lap_1RB____1LC0RD_0LC1RD_0RB0RD.
  - intros t Ht p _. apply fire_1RB____1LC0RD_0LC1RD_0RB0RD. exact Ht.
  - exact wit_1RB____1LC0RD_0LC1RD_0RB0RD.
  - vm_cast_no_check (eq_refl true).
Qed.

Theorem qhtr_1RB____1LC0RD_0LC1RD_0RB0RD : NonHalt tm_1RB____1LC0RD_0LC1RD_0RB0RD /\ QHBoundTr 32779478 tm_1RB____1LC0RD_0LC1RD_0RB0RD /\ QuasiHaltsTr tm_1RB____1LC0RD_0LC1RD_0RB0RD.
Proof. apply (qh_triple_unmirror 32779478 tm_1RB____1LC0RD_0LC1RD_0RB0RD). rewrite mirror_ok_1RB____1LC0RD_0LC1RD_0RB0RD. exact qhtrm_1RB____1LC0RD_0LC1RD_0RB0RD. Qed.
