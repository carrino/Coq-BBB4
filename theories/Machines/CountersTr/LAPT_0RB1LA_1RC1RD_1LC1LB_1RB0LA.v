(** * LAPT_0RB1LA_1RC1RD_1LC1LB_1RB0LA: TRANSITION-LEVEL board for machine 0RB1LA_1RC1RD_1LC1LB_1RB0LA, boarded by CERTIFICATE.
...
Definition pins_0RB1LA_1RC1RD_1LC1LB_1RB0LA : list Instr := [].
Definition tmw_0RB1LA_1RC1RD_1LC1LB_1RB0LA : TM := tm_wrap_trs tmm_0RB1LA_1RC1RD_1LC1LB_1RB0LA pins_0RB1LA_1RC1RD_1LC1LB_1RB0LA.
Local Notation tm := tmw_0RB1LA_1RC1RD_1LC1LB_1RB0LA.
...
Lemma fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_0RB1LA_1RC1RD_1LC1LB_1RB0LA = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_0RB1LA_1RC1RD_1LC1LB_1RB0LA p j [] []);
...
Lemma fire_0RB1LA_1RC1RD_1LC1LB_1RB0LA : forall t, ~ In t pins_0RB1LA_1RC1RD_1LC1LB_1RB0LA ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA
      with (l := []).
    vm_compute; reflexivity.
  - (* A1 *)
    apply (fire_via_ovf tm Cc Hi (StA, S1)), fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 6]).
    vm_compute; reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 1]).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA
      with (l := [SRotL 1; SWin 1]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 2]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 3]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_0RB1LA_1RC1RD_1LC1LB_1RB0LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 1; SWinL 5]).
    vm_compute; reflexivity.
Qed.

Theorem nqhtrm_0RB1LA_1RC1RD_1LC1LB_1RB0LA : NeverQuasiHaltsTr tmm_0RB1LA_1RC1RD_1LC1LB_1RB0LA.
Proof.
  apply (glue_neverqhtr tmm_0RB1LA_1RC1RD_1LC1LB_1RB0LA pins_0RB1LA_1RC1RD_1LC1LB_1RB0LA Cc 3).
  - exact boot_0RB1LA_1RC1RD_1LC1LB_1RB0LA.
  - intros p _. apply lap_0RB1LA_1RC1RD_1LC1LB_1RB0LA.
  - intros t Ht p _. apply fire_0RB1LA_1RC1RD_1LC1LB_1RB0LA. exact Ht.
Qed.

Theorem nqhtr_0RB1LA_1RC1RD_1LC1LB_1RB0LA : NeverQuasiHaltsTr tm_0RB1LA_1RC1RD_1LC1LB_1RB0LA.
Proof. apply (neverqhtr_mirror tm_0RB1LA_1RC1RD_1LC1LB_1RB0LA). rewrite mirror_ok_0RB1LA_1RC1RD_1LC1LB_1RB0LA. exact nqhtrm_0RB1LA_1RC1RD_1LC1LB_1RB0LA. Qed.

Theorem nonhalt_0RB1LA_1RC1RD_1LC1LB_1RB0LA : NonHalt tm_0RB1LA_1RC1RD_1LC1LB_1RB0LA.
Proof. apply never_qh_tr_nonhalt, nqhtr_0RB1LA_1RC1RD_1LC1LB_1RB0LA. Qed.
