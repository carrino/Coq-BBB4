(** * LAPT_1RB1LC_1LC0RD_1LA1LB_0LB1RD: TRANSITION-LEVEL board for machine 1RB1LC_1LC0RD_1LA1LB_0LB1RD, boarded by CERTIFICATE.
...
Definition pins_1RB1LC_1LC0RD_1LA1LB_0LB1RD : list Instr := [].
Definition tmw_1RB1LC_1LC0RD_1LA1LB_0LB1RD : TM := tm_wrap_trs tm_1RB1LC_1LC0RD_1LA1LB_0LB1RD pins_1RB1LC_1LC0RD_1LA1LB_0LB1RD.
Local Notation tm := tmw_1RB1LC_1LC0RD_1LA1LB_0LB1RD.
...
Lemma fireo_1RB1LC_1LC0RD_1LA1LB_0LB1RD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB1LC_1LC0RD_1LA1LB_0LB1RD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB1LC_1LC0RD_1LA1LB_0LB1RD p j [] []);
...
(** An instruction firing in the EXIT chain is reached from the outer overflow
    anchor by boot + the inner counter's own laps + that prefix. *)
Lemma firex_1RB1LC_1LC0RD_1LA1LB_0LB1RD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l BE0_1RB1LC_1LC0RD_1LA1LB_0LB1RD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k e, stepn tm k (lift (Cc p)) = Some e /\ instr_of e = t.
Proof.
  intros l t Hst p j E.
  apply (fire_via_fill tm Cc Cin lapin_1RB1LC_1LC0RD_1LA1LB_0LB1RD t p (pow2 j)).
  - exists (4 * j + 8), (cden [] [] j BB1_1RB1LC_1LC0RD_1LA1LB_0LB1RD). split;
      [| exact (gbo_1RB1LC_1LC0RD_1LA1LB_0LB1RD j)].
    rewrite (gso_1RB1LC_1LC0RD_1LA1LB_0LB1RD p j E).
    exact (srun_sound tm true true chb_1RB1LC_1LC0RD_1LA1LB_0LB1RD B0_1RB1LC_1LC0RD_1LA1LB_0LB1RD BB1_1RB1LC_1LC0RD_1LA1LB_0LB1RD 4 8
...
Lemma fire_1RB1LC_1LC0RD_1LA1LB_0LB1RD : forall t, ~ In t pins_1RB1LC_1LC0RD_1LA1LB_0LB1RD ->
...
Proof.
  ...
  - (* A0: fires in the exit half of the overflow *)
    ...
    apply (fire_via_ovf_lift tm Cc lapil_1RB1LC_1LC0RD_1LA1LB_0LB1RD (StA, S0)).
    intros p1 j1 E1.
    exact (firex_1RB1LC_1LC0RD_1LA1LB_0LB1RD [SCycL 2 0; SWin 4; SWinL 2] (StA, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* A1: fires in the exit half of the overflow *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc lapil_1RB1LC_1LC0RD_1LA1LB_0LB1RD (StA, S1)).
    intros p1 j1 E1.
    exact (firex_1RB1LC_1LC0RD_1LA1LB_0LB1RD [SCycL 2 0; SWin 4] (StA, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_1LC0RD_1LA1LB_0LB1RD [] (StB, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_1LC0RD_1LA1LB_0LB1RD [SCycL 2 0; SWin 2] (StB, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C0: fires in the exit half of the overflow *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc lapil_1RB1LC_1LC0RD_1LA1LB_0LB1RD (StC, S0)).
    intros p1 j1 E1.
    exact (firex_1RB1LC_1LC0RD_1LA1LB_0LB1RD [SCycL 2 0; SWin 3] (StC, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_1LC0RD_1LA1LB_0LB1RD [SCycL 2 0; SWin 1] (StC, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_1LC0RD_1LA1LB_0LB1RD [SCycL 2 0; SWin 4; SCycR 2; SWinR 1] (StD, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LC_1LC0RD_1LA1LB_0LB1RD [SCycL 2 0; SWin 3] (StD, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
Qed.

Theorem nqhtr_1RB1LC_1LC0RD_1LA1LB_0LB1RD : NeverQuasiHaltsTr tm_1RB1LC_1LC0RD_1LA1LB_0LB1RD.
Proof.
  apply (glue_neverqhtr tm_1RB1LC_1LC0RD_1LA1LB_0LB1RD pins_1RB1LC_1LC0RD_1LA1LB_0LB1RD Cc 1).
  - exact boot_1RB1LC_1LC0RD_1LA1LB_0LB1RD.
  - intros p _. apply lap_1RB1LC_1LC0RD_1LA1LB_0LB1RD.
  - intros t Ht p _. apply fire_1RB1LC_1LC0RD_1LA1LB_0LB1RD. exact Ht.
Qed.

Theorem nonhalt_1RB1LC_1LC0RD_1LA1LB_0LB1RD : NonHalt tm_1RB1LC_1LC0RD_1LA1LB_0LB1RD.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB1LC_1LC0RD_1LA1LB_0LB1RD. Qed.
