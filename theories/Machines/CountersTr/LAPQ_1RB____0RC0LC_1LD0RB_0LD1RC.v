(** * LAPQ_1RB____0RC0LC_1LD0RB_0LD1RC: TRANSITION-LEVEL QUASIHALTING-side board for machine 1RB---_0RC0LC_1LD0RB_0LD1RC, boarded by CERTIFICATE.
...
Definition pins_1RB____0RC0LC_1LD0RB_0LD1RC : list Instr := [(StA, S1); (StA, S0); (StB, S1)].
Definition tmw_1RB____0RC0LC_1LD0RB_0LD1RC : TM := tm_wrap_trs tmm_1RB____0RC0LC_1LD0RB_0LD1RC pins_1RB____0RC0LC_1LD0RB_0LD1RC.
Local Notation tm := tmw_1RB____0RC0LC_1LD0RB_0LD1RC.
...
Lemma bootq_1RB____0RC0LC_1LD0RB_0LD1RC : stepn tmm_1RB____0RC0LC_1LD0RB_0LD1RC 17 InitES = Some (lift (Cc 1)).
Proof.
  assert (H : match csteps tmm_1RB____0RC0LC_1LD0RB_0LD1RC 17 c0 with
              | Some c => ceqb c (Cc 1) | None => false end = true)
    by (vm_compute; reflexivity).
  destruct (csteps tmm_1RB____0RC0LC_1LD0RB_0LD1RC 17 c0) as [c|] eqn:E; [|discriminate].
  rewrite <- lift_c0, (csteps_lift _ _ _ _ E). f_equal. apply ceqb_lift. exact H.
Qed.

(** the quasihalt witness: a pinned instruction fired in the prefix *)
Lemma wit_1RB____0RC0LC_1LD0RB_0LD1RC : existsb (fun tg => cfires tmm_1RB____0RC0LC_1LD0RB_0LD1RC c0 17 tg) pins_1RB____0RC0LC_1LD0RB_0LD1RC = true.
Proof. vm_compute. reflexivity. Qed.
...
Lemma fireo_1RB____0RC0LC_1LD0RB_0LD1RC : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB____0RC0LC_1LD0RB_0LD1RC = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB____0RC0LC_1LD0RB_0LD1RC p j [] []);
...
Lemma fire_1RB____0RC0LC_1LD0RB_0LD1RC : forall t, ~ In t pins_1RB____0RC0LC_1LD0RB_0LD1RC ->
...
Proof.
  ...
  - (* A1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB____0RC0LC_1LD0RB_0LD1RC
      with (l := [SWin 3]).
    vm_compute; reflexivity.
  - (* B1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB____0RC0LC_1LD0RB_0LD1RC
      with (l := []).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB____0RC0LC_1LD0RB_0LD1RC
      with (l := [SWin 2]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB____0RC0LC_1LD0RB_0LD1RC
      with (l := [SWin 4; SCycL 2 0; SWin 1; SWinL 2]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB____0RC0LC_1LD0RB_0LD1RC
      with (l := [SWin 1]).
    vm_compute; reflexivity.
Qed.

Theorem qhtrm_1RB____0RC0LC_1LD0RB_0LD1RC : NonHalt tmm_1RB____0RC0LC_1LD0RB_0LD1RC /\ QHBoundTr 32779478 tmm_1RB____0RC0LC_1LD0RB_0LD1RC /\ QuasiHaltsTr tmm_1RB____0RC0LC_1LD0RB_0LD1RC.
Proof.
  apply (lap_qh_stage tmm_1RB____0RC0LC_1LD0RB_0LD1RC pins_1RB____0RC0LC_1LD0RB_0LD1RC Cc 1 17 32779478).
  - exact bootq_1RB____0RC0LC_1LD0RB_0LD1RC.
  - intros p _. apply lap_1RB____0RC0LC_1LD0RB_0LD1RC.
  - intros t Ht p _. apply fire_1RB____0RC0LC_1LD0RB_0LD1RC. exact Ht.
  - exact wit_1RB____0RC0LC_1LD0RB_0LD1RC.
  - vm_cast_no_check (eq_refl true).
Qed.

Theorem qhtr_1RB____0RC0LC_1LD0RB_0LD1RC : NonHalt tm_1RB____0RC0LC_1LD0RB_0LD1RC /\ QHBoundTr 32779478 tm_1RB____0RC0LC_1LD0RB_0LD1RC /\ QuasiHaltsTr tm_1RB____0RC0LC_1LD0RB_0LD1RC.
Proof. apply (qh_triple_unmirror 32779478 tm_1RB____0RC0LC_1LD0RB_0LD1RC). rewrite mirror_ok_1RB____0RC0LC_1LD0RB_0LD1RC. exact qhtrm_1RB____0RC0LC_1LD0RB_0LD1RC. Qed.
