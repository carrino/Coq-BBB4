(** * LAPT_0RB1LC_1LA1RB_1LA0RD_0LC1RD: TRANSITION-LEVEL board for machine 0RB1LC_1LA1RB_1LA0RD_0LC1RD, boarded by CERTIFICATE.
...
Definition pins_0RB1LC_1LA1RB_1LA0RD_0LC1RD : list Instr := [].
Definition tmw_0RB1LC_1LA1RB_1LA0RD_0LC1RD : TM := tm_wrap_trs tm_0RB1LC_1LA1RB_1LA0RD_0LC1RD pins_0RB1LC_1LA1RB_1LA0RD_0LC1RD.
Local Notation tm := tmw_0RB1LC_1LA1RB_1LA0RD_0LC1RD.
...
Lemma fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_0RB1LC_1LA1RB_1LA0RD_0LC1RD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_0RB1LC_1LA1RB_1LA0RD_0LC1RD p j [] []);
...
Lemma fire_0RB1LC_1LA1RB_1LA0RD_0LC1RD : forall t, ~ In t pins_0RB1LC_1LA1RB_1LA0RD_0LC1RD ->
...
Proof.
  ...
  - (* A0 *)
    ...
    apply (fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD [SCycL 2 0; SWin 2; SWinL 1] (StA, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* A1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StA, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD [SCycL 2 0; SWin 1] (StA, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD [SCycL 2 0; SWin 2; SWinL 4; SCycR 2; SWin 2; SWinR 1] (StB, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD [SCycL 2 0; SWin 2; SWinL 2] (StB, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD [] (StC, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD [SCycL 2 0; SWin 2; SWinL 4; SCycR 2; SWin 2; SWinR 3] (StC, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD [SCycL 2 0; SWin 2; SWinL 4; SCycR 2; SWin 2; SWinR 6] (StD, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_0RB1LC_1LA1RB_1LA0RD_0LC1RD [SCycL 2 0; SWin 2; SWinL 4; SCycR 2; SWin 2; SWinR 4] (StD, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
Qed.

Theorem nqhtr_0RB1LC_1LA1RB_1LA0RD_0LC1RD : NeverQuasiHaltsTr tm_0RB1LC_1LA1RB_1LA0RD_0LC1RD.
Proof.
  apply (glue_neverqhtr tm_0RB1LC_1LA1RB_1LA0RD_0LC1RD pins_0RB1LC_1LA1RB_1LA0RD_0LC1RD Cc 1).
  - exact boot_0RB1LC_1LA1RB_1LA0RD_0LC1RD.
  - intros p _. apply lap_0RB1LC_1LA1RB_1LA0RD_0LC1RD.
  - intros t Ht p _. apply fire_0RB1LC_1LA1RB_1LA0RD_0LC1RD. exact Ht.
Qed.

Theorem nonhalt_0RB1LC_1LA1RB_1LA0RD_0LC1RD : NonHalt tm_0RB1LC_1LA1RB_1LA0RD_0LC1RD.
Proof. apply never_qh_tr_nonhalt, nqhtr_0RB1LC_1LA1RB_1LA0RD_0LC1RD. Qed.
