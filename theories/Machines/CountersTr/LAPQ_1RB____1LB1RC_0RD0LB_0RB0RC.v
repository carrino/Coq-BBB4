(** * LAPQ_1RB____1LB1RC_0RD0LB_0RB0RC: TRANSITION-LEVEL QUASIHALTING-side board for machine 1RB---_1LB1RC_0RD0LB_0RB0RC, boarded by CERTIFICATE.
...
Definition pins_1RB____1LB1RC_0RD0LB_0RB0RC : list Instr := [(StA, S1); (StA, S0)].
Definition tmw_1RB____1LB1RC_0RD0LB_0RB0RC : TM := tm_wrap_trs tmm_1RB____1LB1RC_0RD0LB_0RB0RC pins_1RB____1LB1RC_0RD0LB_0RB0RC.
Local Notation tm := tmw_1RB____1LB1RC_0RD0LB_0RB0RC.
...
Lemma bootq_1RB____1LB1RC_0RD0LB_0RB0RC : stepn tmm_1RB____1LB1RC_0RD0LB_0RB0RC 9 InitES = Some (lift (Cc 1)).
Proof.
  assert (H : match csteps tmm_1RB____1LB1RC_0RD0LB_0RB0RC 9 c0 with
              | Some c => ceqb c (Cc 1) | None => false end = true)
    by (vm_compute; reflexivity).
  destruct (csteps tmm_1RB____1LB1RC_0RD0LB_0RB0RC 9 c0) as [c|] eqn:E; [|discriminate].
  rewrite <- lift_c0, (csteps_lift _ _ _ _ E). f_equal. apply ceqb_lift. exact H.
Qed.

(** the quasihalt witness: a pinned instruction fired in the prefix *)
Lemma wit_1RB____1LB1RC_0RD0LB_0RB0RC : existsb (fun tg => cfires tmm_1RB____1LB1RC_0RD0LB_0RB0RC c0 9 tg) pins_1RB____1LB1RC_0RD0LB_0RB0RC = true.
Proof. vm_compute. reflexivity. Qed.
...
Lemma fireo_1RB____1LB1RC_0RD0LB_0RB0RC : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB____1LB1RC_0RD0LB_0RB0RC = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB____1LB1RC_0RD0LB_0RB0RC p j [] []);
...
Lemma firex_1RB____1LB1RC_0RD0LB_0RB0RC : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l BE0_1RB____1LB1RC_0RD0LB_0RB0RC = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k e, stepn tm k (lift (Cc p)) = Some e /\ instr_of e = t.
Proof.
  intros l t Hst p j E.
  apply (fire_via_fill tm Cc Cin lapin_1RB____1LB1RC_0RD0LB_0RB0RC t p (pow2 j)).
  - exists (4 * j + 8), (cden [] [] j BB1_1RB____1LB1RC_0RD0LB_0RB0RC). split;
      [| exact (gbo_1RB____1LB1RC_0RD0LB_0RB0RC j)].
    rewrite (gso_1RB____1LB1RC_0RD0LB_0RB0RC p j E).
    exact (srun_sound tm true true chb_1RB____1LB1RC_0RD0LB_0RB0RC B0_1RB____1LB1RC_0RD0LB_0RB0RC BB1_1RB____1LB1RC_0RD0LB_0RB0RC 4 8
             run_boot_1RB____1LB1RC_0RD0LB_0RB0RC [] [] j ltac:(reflexivity) ltac:(reflexivity)).
  - apply (fire_lift_of_csteps tm (fun _ : positive => Cin (fill (pow2 j))) xH).
    apply (fire_of_run_instr tm (fun _ : positive => Cin (fill (pow2 j)))
                      true true l BE0_1RB____1LB1RC_0RD0LB_0RB0RC xH j [] []);
      [exact Hst | reflexivity | reflexivity | exact (gxi_1RB____1LB1RC_0RD0LB_0RB0RC j)].
Qed.
...
Lemma fire_1RB____1LB1RC_0RD0LB_0RB0RC : forall t, ~ In t pins_1RB____1LB1RC_0RD0LB_0RB0RC ->
...
Proof.
  ...
  - (* A1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_1RB____1LB1RC_0RD0LB_0RB0RC
      with (l := []).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_1RB____1LB1RC_0RD0LB_0RB0RC
      with (l := [SWin 1]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB____1LB1RC_0RD0LB_0RB0RC
      with (l := [SWin 4]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB____1LB1RC_0RD0LB_0RB0RC
      with (l := [SWin 2]).
    vm_compute; reflexivity.
  - (* D0: fires in the exit half of the overflow *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc lapil_1RB____1LB1RC_0RD0LB_0RB0RC (StD, S0)).
    intros p1 j1 E1.
    exact (firex_1RB____1LB1RC_0RD0LB_0RB0RC [SWin 4; SCycL 2 0; SWin 1; SWinL 2] (StD, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB____1LB1RC_0RD0LB_0RB0RC
      with (l := [SWin 4; SCycL 2 0; SWin 1]).
    vm_compute; reflexivity.
Qed.

Theorem qhtrm_1RB____1LB1RC_0RD0LB_0RB0RC : NonHalt tmm_1RB____1LB1RC_0RD0LB_0RB0RC /\ QHBoundTr 32779478 tmm_1RB____1LB1RC_0RD0LB_0RB0RC /\ QuasiHaltsTr tmm_1RB____1LB1RC_0RD0LB_0RB0RC.
Proof.
  apply (lap_qh_stage tmm_1RB____1LB1RC_0RD0LB_0RB0RC pins_1RB____1LB1RC_0RD0LB_0RB0RC Cc 1 9 32779478).
  - exact bootq_1RB____1LB1RC_0RD0LB_0RB0RC.
  - intros p _. apply lap_1RB____1LB1RC_0RD0LB_0RB0RC.
  - intros t Ht p _. apply fire_1RB____1LB1RC_0RD0LB_0RB0RC. exact Ht.
  - exact wit_1RB____1LB1RC_0RD0LB_0RB0RC.
  - vm_cast_no_check (eq_refl true).
Qed.

Theorem qhtr_1RB____1LB1RC_0RD0LB_0RB0RC : NonHalt tm_1RB____1LB1RC_0RD0LB_0RB0RC /\ QHBoundTr 32779478 tm_1RB____1LB1RC_0RD0LB_0RB0RC /\ QuasiHaltsTr tm_1RB____1LB1RC_0RD0LB_0RB0RC.
Proof. apply (qh_triple_unmirror 32779478 tm_1RB____1LB1RC_0RD0LB_0RB0RC). rewrite mirror_ok_1RB____1LB1RC_0RD0LB_0RB0RC. exact qhtrm_1RB____1LB1RC_0RD0LB_0RB0RC. Qed.
