(** * LAPT_1RB1LA_1RC0LD_0LA1RB_0RC1LD: TRANSITION-LEVEL board for machine 1RB1LA_1RC0LD_0LA1RB_0RC1LD, boarded by CERTIFICATE.
...
Definition pins_1RB1LA_1RC0LD_0LA1RB_0RC1LD : list Instr := [].
Definition tmw_1RB1LA_1RC0LD_0LA1RB_0RC1LD : TM := tm_wrap_trs tmm_1RB1LA_1RC0LD_0LA1RB_0RC1LD pins_1RB1LA_1RC0LD_0LA1RB_0RC1LD.
Local Notation tm := tmw_1RB1LA_1RC0LD_0LA1RB_0RC1LD.
...
Lemma fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB1LA_1RC0LD_0LA1RB_0RC1LD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB1LA_1RC0LD_0LA1RB_0RC1LD p j [] []);
...
Lemma fire_1RB1LA_1RC0LD_0LA1RB_0RC1LD : forall t, ~ In t pins_1RB1LA_1RC0LD_0LA1RB_0RC1LD ->
...
Proof.
  ...
  - (* A0 *)
    ...
    apply (fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD [SCycL 2 0; SWin 2; SWinL 4; SCycR 2; SWin 1; SWinR 1] (StA, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* A1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StA, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD [SCycL 2 0; SWin 2; SWinL 2] (StA, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD [] (StB, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD [SCycL 2 0; SWin 2; SWinL 4; SCycR 2; SWin 1; SWinR 2] (StB, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD [SCycL 2 0; SWin 2; SWinL 1] (StC, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD [SCycL 2 0; SWin 1] (StC, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD [SCycL 2 0; SWin 2; SWinL 4; SCycR 2; SWin 1; SWinR 4] (StD, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC0LD_0LA1RB_0RC1LD [SCycL 2 0; SWin 2; SWinL 4; SCycR 2; SWin 1; SWinR 3] (StD, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
Qed.

Theorem nqhtrm_1RB1LA_1RC0LD_0LA1RB_0RC1LD : NeverQuasiHaltsTr tmm_1RB1LA_1RC0LD_0LA1RB_0RC1LD.
Proof.
  apply (glue_neverqhtr tmm_1RB1LA_1RC0LD_0LA1RB_0RC1LD pins_1RB1LA_1RC0LD_0LA1RB_0RC1LD Cc 1).
  - exact boot_1RB1LA_1RC0LD_0LA1RB_0RC1LD.
  - intros p _. apply lap_1RB1LA_1RC0LD_0LA1RB_0RC1LD.
  - intros t Ht p _. apply fire_1RB1LA_1RC0LD_0LA1RB_0RC1LD. exact Ht.
Qed.

Theorem nqhtr_1RB1LA_1RC0LD_0LA1RB_0RC1LD : NeverQuasiHaltsTr tm_1RB1LA_1RC0LD_0LA1RB_0RC1LD.
Proof. apply (neverqhtr_mirror tm_1RB1LA_1RC0LD_0LA1RB_0RC1LD). rewrite mirror_ok_1RB1LA_1RC0LD_0LA1RB_0RC1LD. exact nqhtrm_1RB1LA_1RC0LD_0LA1RB_0RC1LD. Qed.

Theorem nonhalt_1RB1LA_1RC0LD_0LA1RB_0RC1LD : NonHalt tm_1RB1LA_1RC0LD_0LA1RB_0RC1LD.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB1LA_1RC0LD_0LA1RB_0RC1LD. Qed.
