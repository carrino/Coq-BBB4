(** * LAPT_0RB0RC_1LC0RB_0LD1RA_1RC1LD: TRANSITION-LEVEL board for machine 0RB0RC_1LC0RB_0LD1RA_1RC1LD, boarded by CERTIFICATE.
...
Definition pins_0RB0RC_1LC0RB_0LD1RA_1RC1LD : list Instr := [].
Definition tmw_0RB0RC_1LC0RB_0LD1RA_1RC1LD : TM := tm_wrap_trs tm_0RB0RC_1LC0RB_0LD1RA_1RC1LD pins_0RB0RC_1LC0RB_0LD1RA_1RC1LD.
Local Notation tm := tmw_0RB0RC_1LC0RB_0LD1RA_1RC1LD.

Definition Cc_0RB0RC_1LC0RB_0LD1RA_1RC1LD (p : positive) : cconf := (StD, (Ap_Alph_10_11_11 p ++ [S0], S0, [S0;S1])).
...
Lemma gsi_0RB0RC_1LC0RB_0LD1RA_1RC1LD : forall p j q0, cview p = (j, Some q0) ->
  Cc p = cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A0_0RB0RC_1LC0RB_0LD1RA_1RC1LD.
Proof.
...
Lemma gei_0RB0RC_1LC0RB_0LD1RA_1RC1LD : forall p j q0, cview p = (j, Some q0) ->
  cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A1_0RB0RC_1LC0RB_0LD1RA_1RC1LD = Cc (Pos.succ p).
Proof.
...
Proof.
  ...
  rewrite (srun_sound tm false true chi_0RB0RC_1LC0RB_0LD1RA_1RC1LD A0_0RB0RC_1LC0RB_0LD1RA_1RC1LD A1_0RB0RC_1LC0RB_0LD1RA_1RC1LD 4 8
             run_int_0RB0RC_1LC0RB_0LD1RA_1RC1LD (Ap_Alph_10_11_11 q0 ++ [S0]) [] j
...
Proof.
  ...
  { unfold Cc_0RB0RC_1LC0RB_0LD1RA_1RC1LD. rewrite H2.
...
Lemma fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_0RB0RC_1LC0RB_0LD1RA_1RC1LD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_0RB0RC_1LC0RB_0LD1RA_1RC1LD p j [] []);
...
Lemma fire_0RB0RC_1LC0RB_0LD1RA_1RC1LD : forall t, ~ In t pins_0RB0RC_1LC0RB_0LD1RA_1RC1LD ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD
      with (l := [SWin 2; SCycL 2 0; SWin 6; SCycR 2; SWin 1]).
    vm_compute; reflexivity.
  - (* A1 *)
    apply (fire_via_ovf tm Cc Hi (StA, S1)), fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD
      with (l := [SWin 2; SCycL 2 0; SWin 5]).
    vm_compute; reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD
      with (l := [SWin 2; SCycL 2 0; SWin 6; SCycR 2; SWin 2; SWinR 1]).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD
      with (l := [SWin 2; SCycL 2 0; SWin 6; SCycR 2; SWin 2]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD
      with (l := [SWin 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD
      with (l := [SWin 2; SCycL 2 0; SWin 4]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD
      with (l := []).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_0RB0RC_1LC0RB_0LD1RA_1RC1LD
      with (l := [SWin 2]).
    vm_compute; reflexivity.
Qed.

Theorem nqhtr_0RB0RC_1LC0RB_0LD1RA_1RC1LD : NeverQuasiHaltsTr tm_0RB0RC_1LC0RB_0LD1RA_1RC1LD.
Proof.
  apply (glue_neverqhtr tm_0RB0RC_1LC0RB_0LD1RA_1RC1LD pins_0RB0RC_1LC0RB_0LD1RA_1RC1LD Cc 1).
  - exact boot_0RB0RC_1LC0RB_0LD1RA_1RC1LD.
  - intros p _. apply lap_0RB0RC_1LC0RB_0LD1RA_1RC1LD.
  - intros t Ht p _. apply fire_0RB0RC_1LC0RB_0LD1RA_1RC1LD. exact Ht.
Qed.

Theorem nonhalt_0RB0RC_1LC0RB_0LD1RA_1RC1LD : NonHalt tm_0RB0RC_1LC0RB_0LD1RA_1RC1LD.
Proof. apply never_qh_tr_nonhalt, nqhtr_0RB0RC_1LC0RB_0LD1RA_1RC1LD. Qed.
