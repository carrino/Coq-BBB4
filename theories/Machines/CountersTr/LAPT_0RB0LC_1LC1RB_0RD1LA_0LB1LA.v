(** * LAPT_0RB0LC_1LC1RB_0RD1LA_0LB1LA: TRANSITION-LEVEL board for machine 0RB0LC_1LC1RB_0RD1LA_0LB1LA, boarded by CERTIFICATE.
...
Definition pins_0RB0LC_1LC1RB_0RD1LA_0LB1LA : list Instr := [].
Definition tmw_0RB0LC_1LC1RB_0RD1LA_0LB1LA : TM := tm_wrap_trs tmm_0RB0LC_1LC1RB_0RD1LA_0LB1LA pins_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
Local Notation tm := tmw_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
...
Definition Cc_0RB0LC_1LC1RB_0RD1LA_0LB1LA (p : positive) : cconf := (StA, (Ap_Alph_10_11_11 p ++ [S0], S0, [])).
...
Definition B1_0RB0LC_1LC1RB_0RD1LA_0LB1LA : sconf := mkC StA (mkS [] [S1;S0] 1 1 [S1;S1]) S0 (mkS [] [] 0 0 []).
Definition cho_0RB0LC_1LC1RB_0RD1LA_0LB1LA : list lstep := [SRotL 1; SWin 1; SCycL 2 0; SWin 4; SCycR 2; SWin 3; SWinR 3; SFoldL 1].
...
Lemma gsi_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall p j q0, cview p = (j, Some q0) ->
  Cc p = cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A0_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
Proof.
...
Lemma gei_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall p j q0, cview p = (j, Some q0) ->
  cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A1_0RB0LC_1LC1RB_0RD1LA_0LB1LA = Cc (Pos.succ p).
Proof.
...
Proof.
  ...
  rewrite (srun_sound tm false true chi_0RB0LC_1LC1RB_0RD1LA_0LB1LA A0_0RB0LC_1LC1RB_0RD1LA_0LB1LA A1_0RB0LC_1LC1RB_0RD1LA_0LB1LA 4 4
             run_int_0RB0LC_1LC1RB_0RD1LA_0LB1LA (Ap_Alph_10_11_11 q0 ++ [S0]) [] j
...
Proof.
  ...
  { unfold Cc_0RB0LC_1LC1RB_0RD1LA_0LB1LA. rewrite H2.
...
Lemma fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_0RB0LC_1LC1RB_0RD1LA_0LB1LA = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_0RB0LC_1LC1RB_0RD1LA_0LB1LA p j [] []);
...
Lemma fire_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall t, ~ In t pins_0RB0LC_1LC1RB_0RD1LA_0LB1LA ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA
      with (l := []).
    vm_compute; reflexivity.
  - (* A1 *)
    apply (fire_via_ovf tm Cc Hi (StA, S1)), fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 4]).
    vm_compute; reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 2]).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA
      with (l := [SRotL 1; SWin 1]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 4; SCycR 2; SWin 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 3]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 4; SCycR 2; SWin 2]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_0RB0LC_1LC1RB_0RD1LA_0LB1LA
      with (l := [SRotL 1; SWin 1; SCycL 2 0; SWin 4; SCycR 2; SWin 3; SWinR 2]).
    vm_compute; reflexivity.
Qed.

Theorem nqhtrm_0RB0LC_1LC1RB_0RD1LA_0LB1LA : NeverQuasiHaltsTr tmm_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
Proof.
  apply (glue_neverqhtr tmm_0RB0LC_1LC1RB_0RD1LA_0LB1LA pins_0RB0LC_1LC1RB_0RD1LA_0LB1LA Cc 1).
  - exact boot_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
  - intros p _. apply lap_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
  - intros t Ht p _. apply fire_0RB0LC_1LC1RB_0RD1LA_0LB1LA. exact Ht.
Qed.

Theorem nqhtr_0RB0LC_1LC1RB_0RD1LA_0LB1LA : NeverQuasiHaltsTr tm_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
Proof. apply (neverqhtr_mirror tm_0RB0LC_1LC1RB_0RD1LA_0LB1LA). rewrite mirror_ok_0RB0LC_1LC1RB_0RD1LA_0LB1LA. exact nqhtrm_0RB0LC_1LC1RB_0RD1LA_0LB1LA. Qed.

Theorem nonhalt_0RB0LC_1LC1RB_0RD1LA_0LB1LA : NonHalt tm_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
Proof. apply never_qh_tr_nonhalt, nqhtr_0RB0LC_1LC1RB_0RD1LA_0LB1LA. Qed.
