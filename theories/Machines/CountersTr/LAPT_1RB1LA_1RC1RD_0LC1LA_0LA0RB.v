(** * LAPT_1RB1LA_1RC1RD_0LC1LA_0LA0RB: TRANSITION-LEVEL board for machine 1RB1LA_1RC1RD_0LC1LA_0LA0RB, boarded by CERTIFICATE.
...
Definition pins_1RB1LA_1RC1RD_0LC1LA_0LA0RB : list Instr := [].
Definition tmw_1RB1LA_1RC1RD_0LC1LA_0LA0RB : TM := tm_wrap_trs tm_1RB1LA_1RC1RD_0LC1LA_0LA0RB pins_1RB1LA_1RC1RD_0LC1LA_0LA0RB.
Local Notation tm := tmw_1RB1LA_1RC1RD_0LC1LA_0LA0RB.
...
Lemma fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB1LA_1RC1RD_0LC1LA_0LA0RB = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB1LA_1RC1RD_0LC1LA_0LA0RB p j [] []);
...
Lemma fire_1RB1LA_1RC1RD_0LC1LA_0LA0RB : forall t, ~ In t pins_1RB1LA_1RC1RD_0LC1LA_0LA0RB ->
...
Proof.
  ...
  - (* A0 *)
    ...
    apply (fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB [] (StA, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* A1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StA, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB [SWin 1; SWinR 2] (StA, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB [SWin 1; SWinR 3; SCycL 2 0; SWin 6; SCycR 2; SWin 2] (StB, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* B1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StB, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB [SWin 1] (StB, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB [SWin 1; SWinR 3; SCycL 2 0; SWin 6; SCycR 2; SWin 2; SWinR 1] (StC, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* C1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StC, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB [SWin 1; SWinR 3; SCycL 2 0; SWin 6; SCycR 2; SWin 2; SWinR 2] (StC, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D0 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S0)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB [SWin 1; SWinR 1] (StD, S0) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
  - (* D1 *)
    apply (fire_csteps_of_lift tm Cc).
    apply (fire_via_ovf_lift tm Cc Hi (StD, S1)).
    intros p1 j1 E1. apply (fire_lift_of_csteps tm Cc).
    apply (fireo_1RB1LA_1RC1RD_0LC1LA_0LA0RB [SWin 1; SWinR 3; SCycL 2 0; SWin 5] (StD, S1) ltac:(vm_compute; reflexivity)
                   p1 j1 E1).
Qed.

Theorem nqhtr_1RB1LA_1RC1RD_0LC1LA_0LA0RB : NeverQuasiHaltsTr tm_1RB1LA_1RC1RD_0LC1LA_0LA0RB.
Proof.
  apply (glue_neverqhtr tm_1RB1LA_1RC1RD_0LC1LA_0LA0RB pins_1RB1LA_1RC1RD_0LC1LA_0LA0RB Cc 1).
  - exact boot_1RB1LA_1RC1RD_0LC1LA_0LA0RB.
  - intros p _. apply lap_1RB1LA_1RC1RD_0LC1LA_0LA0RB.
  - intros t Ht p _. apply fire_1RB1LA_1RC1RD_0LC1LA_0LA0RB. exact Ht.
Qed.

Theorem nonhalt_1RB1LA_1RC1RD_0LC1LA_0LA0RB : NonHalt tm_1RB1LA_1RC1RD_0LC1LA_0LA0RB.
Proof. apply never_qh_tr_nonhalt, nqhtr_1RB1LA_1RC1RD_0LC1LA_0LA0RB. Qed.
