(** * LAPQ_1RB0LC_1LB1LA_0RC1LD_1RC0LD: TRANSITION-LEVEL QUASIHALTING-side board for machine 1RB0LC_1LB1LA_0RC1LD_1RC0LD, boarded by CERTIFICATE.
...
Definition pins_1RB0LC_1LB1LA_0RC1LD_1RC0LD : list Instr := [(StA, S0); (StA, S1); (StB, S0); (StB, S1)].
Definition tmw_1RB0LC_1LB1LA_0RC1LD_1RC0LD : TM := tm_wrap_trs tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD pins_1RB0LC_1LB1LA_0RC1LD_1RC0LD.
Local Notation tm := tmw_1RB0LC_1LB1LA_0RC1LD_1RC0LD.
...
Lemma bootq_1RB0LC_1LB1LA_0RC1LD_1RC0LD : stepn tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD 13 InitES = Some (lift (Cc 1)).
Proof.
  assert (H : match csteps tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD 13 c0 with
              | Some c => ceqb c (Cc 1) | None => false end = true)
    by (vm_compute; reflexivity).
  destruct (csteps tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD 13 c0) as [c|] eqn:E; [|discriminate].
  rewrite <- lift_c0, (csteps_lift _ _ _ _ E). f_equal. apply ceqb_lift. exact H.
Qed.

(** the quasihalt witness: a pinned instruction fired in the prefix *)
Lemma wit_1RB0LC_1LB1LA_0RC1LD_1RC0LD : existsb (fun tg => cfires tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD c0 13 tg) pins_1RB0LC_1LB1LA_0RC1LD_1RC0LD = true.
Proof. vm_compute. reflexivity. Qed.
...
Lemma fireo_1RB0LC_1LB1LA_0RC1LD_1RC0LD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_1RB0LC_1LB1LA_0RC1LD_1RC0LD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_1RB0LC_1LB1LA_0RC1LD_1RC0LD p j [] []);
...
Lemma fire_1RB0LC_1LB1LA_0RC1LD_1RC0LD : forall t, ~ In t pins_1RB0LC_1LB1LA_0RC1LD_1RC0LD ->
...
Proof.
  ...
  - (* B1: pinned *)
    exfalso. apply Hnp. apply tr_inb_spec. reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_1RB0LC_1LB1LA_0RC1LD_1RC0LD
      with (l := []).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_1RB0LC_1LB1LA_0RC1LD_1RC0LD
      with (l := [SWin 1]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_1RB0LC_1LB1LA_0RC1LD_1RC0LD
      with (l := [SWin 2]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_1RB0LC_1LB1LA_0RC1LD_1RC0LD
      with (l := [SWin 4]).
    vm_compute; reflexivity.
Qed.

Theorem qhtr_1RB0LC_1LB1LA_0RC1LD_1RC0LD : NonHalt tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD /\ QHBoundTr 32779478 tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD /\ QuasiHaltsTr tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD.
Proof.
  apply (lap_qh_stage tm_1RB0LC_1LB1LA_0RC1LD_1RC0LD pins_1RB0LC_1LB1LA_0RC1LD_1RC0LD Cc 1 13 32779478).
  - exact bootq_1RB0LC_1LB1LA_0RC1LD_1RC0LD.
  - intros p _. apply lap_1RB0LC_1LB1LA_0RC1LD_1RC0LD.
  - intros t Ht p _. apply fire_1RB0LC_1LB1LA_0RC1LD_1RC0LD. exact Ht.
  - exact wit_1RB0LC_1LB1LA_0RC1LD_1RC0LD.
