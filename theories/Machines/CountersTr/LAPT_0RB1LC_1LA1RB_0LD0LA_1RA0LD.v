(** * LAPT_0RB1LC_1LA1RB_0LD0LA_1RA0LD: TRANSITION-LEVEL board for machine 0RB1LC_1LA1RB_0LD0LA_1RA0LD, boarded by CERTIFICATE.
...
Definition pins_0RB1LC_1LA1RB_0LD0LA_1RA0LD : list Instr := [].
Definition tmw_0RB1LC_1LA1RB_0LD0LA_1RA0LD : TM := tm_wrap_trs tmm_0RB1LC_1LA1RB_0LD0LA_1RA0LD pins_0RB1LC_1LA1RB_0LD0LA_1RA0LD.
Local Notation tm := tmw_0RB1LC_1LA1RB_0LD0LA_1RA0LD.
...
Definition Cc_0RB1LC_1LA1RB_0LD0LA_1RA0LD (p : positive) : cconf := (StB, (Ap_Alph_10_11_11 p ++ [S0], S0, [S0;S1])).
...
Lemma gsi_0RB1LC_1LA1RB_0LD0LA_1RA0LD : forall p j q0, cview p = (j, Some q0) ->
  Cc p = cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A0_0RB1LC_1LA1RB_0LD0LA_1RA0LD.
Proof.
...
Lemma gei_0RB1LC_1LA1RB_0LD0LA_1RA0LD : forall p j q0, cview p = (j, Some q0) ->
  cden (Ap_Alph_10_11_11 q0 ++ [S0]) [] j A1_0RB1LC_1LA1RB_0LD0LA_1RA0LD = Cc (Pos.succ p).
Proof.
...
Proof.
  ...
  rewrite (srun_sound tm false true chi_0RB1LC_1LA1RB_0LD0LA_1RA0LD A0_0RB1LC_1LA1RB_0LD0LA_1RA0LD A1_0RB1LC_1LA1RB_0LD0LA_1RA0LD 4 8
             run_int_0RB1LC_1LA1RB_0LD0LA_1RA0LD (Ap_Alph_10_11_11 q0 ++ [S0]) [] j
...
Proof.
  ...
  { unfold Cc_0RB1LC_1LA1RB_0LD0LA_1RA0LD. rewrite H2.
...
Lemma fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD : forall (l : list lstep) (t : Instr),
  srun_instr tm true true l B0_0RB1LC_1LA1RB_0LD0LA_1RA0LD = Some t ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ cinstr c = t.
Proof.
  intros l t Hst p j E.
  apply (fire_of_run_instr tm Cc true true l B0_0RB1LC_1LA1RB_0LD0LA_1RA0LD p j [] []);
...
Lemma fire_0RB1LC_1LA1RB_0LD0LA_1RA0LD : forall t, ~ In t pins_0RB1LC_1LA1RB_0LD0LA_1RA0LD ->
...
Proof.
  ...
  - (* A0 *)
    apply (fire_via_ovf tm Cc Hi (StA, S0)), fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD
      with (l := [SWin 1]).
    vm_compute; reflexivity.
  - (* A1 *)
    apply (fire_via_ovf tm Cc Hi (StA, S1)), fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD
      with (l := [SWin 2; SCycL 2 0; SWin 4]).
    vm_compute; reflexivity.
  - (* B0 *)
    apply (fire_via_ovf tm Cc Hi (StB, S0)), fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD
      with (l := []).
    vm_compute; reflexivity.
  - (* B1 *)
    apply (fire_via_ovf tm Cc Hi (StB, S1)), fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD
      with (l := [SWin 2]).
    vm_compute; reflexivity.
  - (* C0 *)
    apply (fire_via_ovf tm Cc Hi (StC, S0)), fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD
      with (l := [SWin 2; SCycL 2 0; SWin 6; SCycR 2; SWin 1]).
    vm_compute; reflexivity.
  - (* C1 *)
    apply (fire_via_ovf tm Cc Hi (StC, S1)), fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD
      with (l := [SWin 2; SCycL 2 0; SWin 5]).
    vm_compute; reflexivity.
  - (* D0 *)
    apply (fire_via_ovf tm Cc Hi (StD, S0)), fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD
      with (l := [SWin 2; SCycL 2 0; SWin 6; SCycR 2; SWin 2; SWinR 1]).
    vm_compute; reflexivity.
  - (* D1 *)
    apply (fire_via_ovf tm Cc Hi (StD, S1)), fireo_0RB1LC_1LA1RB_0LD0LA_1RA0LD
      with (l := [SWin 2; SCycL 2 0; SWin 6; SCycR 2; SWin 2]).
    vm_compute; reflexivity.
Qed.

Theorem nqhtrm_0RB1LC_1LA1RB_0LD0LA_1RA0LD : NeverQuasiHaltsTr tmm_0RB1LC_1LA1RB_0LD0LA_1RA0LD.
Proof.
  apply (glue_neverqhtr tmm_0RB1LC_1LA1RB_0LD0LA_1RA0LD pins_0RB1LC_1LA1RB_0LD0LA_1RA0LD Cc 1).
  - exact boot_0RB1LC_1LA1RB_0LD0LA_1RA0LD.
  - intros p _. apply lap_0RB1LC_1LA1RB_0LD0LA_1RA0LD.
  - intros t Ht p _. apply fire_0RB1LC_1LA1RB_0LD0LA_1RA0LD. exact Ht.
Qed.

Theorem nqhtr_0RB1LC_1LA1RB_0LD0LA_1RA0LD : NeverQuasiHaltsTr tm_0RB1LC_1LA1RB_0LD0LA_1RA0LD.
Proof. apply (neverqhtr_mirror tm_0RB1LC_1LA1RB_0LD0LA_1RA0LD). rewrite mirror_ok_0RB1LC_1LA1RB_0LD0LA_1RA0LD. exact nqhtrm_0RB1LC_1LA1RB_0LD0LA_1RA0LD. Qed.

Theorem nonhalt_0RB1LC_1LA1RB_0LD0LA_1RA0LD : NonHalt tm_0RB1LC_1LA1RB_0LD0LA_1RA0LD.
Proof. apply never_qh_tr_nonhalt, nqhtr_0RB1LC_1LA1RB_0LD0LA_1RA0LD. Qed.
