(** * RRPartner_01: 0RB1LC_1LA1RB_0RD0LA_1LB0RD never quasihalts, by RE-ROOT TRANSPORT.
    ...
    never-quasihalter [1RB1LA_0LA1RC_0LD0RB_1RA0LD], so no new machine analysis
...
Require BBB4.Machines.Counters.NLAP_1RB1LA_0LA1RC_0LD0RB_1RA0LD.
...
Definition tm_0RB1LC_1LA1RB_0RD0LA_1LB0RD : TM := fun q s =>
  match q, s with
  | StA, S0 => mk S0 DR StB
  | StA, S1 => mk S1 DL StC
  | StB, S0 => mk S1 DL StA
...
Local Notation tm := tm_0RB1LC_1LA1RB_0RD0LA_1LB0RD.
...
Proof.
  assert (E : csteps core 6 c0 = Some (StD, ([S0], S1, [S1])))
    by (vm_compute; reflexivity).
  eexists. split.
...
Theorem nqh_0RB1LC_1LA1RB_0RD0LA_1LB0RD : NeverQuasiHaltsSt tm.
Proof.
  apply (neverqh_reroot tm StB 1).
  - apply prefix_ok_sound. vm_compute. reflexivity.
  - apply mirror_never_qh.
    assert (Heq : mirror_tm core = BBB4.Machines.Counters.NLAP_1RB1LA_0LA1RC_0LD0RB_1RA0LD.tm_1RB1LA_0LA1RC_0LD0RB_1RA0LD)
      by (apply tm_eqb_eq; vm_compute; reflexivity).
    rewrite Heq. exact BBB4.Machines.Counters.NLAP_1RB1LA_0LA1RC_0LD0RB_1RA0LD.nqh_1RB1LA_0LA1RC_0LD0RB_1RA0LD.
  - intro q. destruct q.
...
Print Assumptions nqh_0RB1LC_1LA1RB_0RD0LA_1LB0RD.
