(** * ILC_1RB1RD_0LC1RD_1RB1LC_1LA0RB: comb-free interleaved binary counter, machine 1RB1RD_0LC1RD_1RB1LC_1LA0RB.
...
Definition Cc_1RB1RD_0LC1RD_1RB1LC_1LA0RB (p : positive) : cconf := (StC, (Ip p ++ [S1], S1, [S0])).
Local Notation Cc := Cc_1RB1RD_0LC1RD_1RB1LC_1LA0RB.

(** ** The lap unit windows (each closed by [reflexivity]) *)
Lemma U_P1_1RB1RD_0LC1RD_1RB1LC_1LA0RB : wsteps true true tm 1 (StC,([S1],S1,[])) = Some (StC,([],S1,[S1])). Proof. reflexivity. Qed.
Lemma U_RIP_1RB1RD_0LC1RD_1RB1LC_1LA0RB : wsteps true true tm 2 (StC,([S1;S1],S1,[])) = Some (StC,([],S1,[S1;S1])). Proof. reflexivity. Qed.
Lemma U_STPI_1RB1RD_0LC1RD_1RB1LC_1LA0RB : wsteps true true tm 2 (StC,([S0],S1,[])) = Some (StB,([S1],S1,[])). Proof. reflexivity. Qed.
Lemma U_STPO_1RB1RD_0LC1RD_1RB1LC_1LA0RB : wsteps false true tm 3 (StC,([S1],S1,[])) = Some (StB,([S1],S1,[S1])). Proof. reflexivity. Qed.
Lemma U_RET_1RB1RD_0LC1RD_1RB1LC_1LA0RB : wsteps true true tm 2 (StB,([],S1,[S1;S1])) = Some (StB,([S0;S1],S1,[])). Proof. reflexivity. Qed.
Lemma U_FINI_1RB1RD_0LC1RD_1RB1LC_1LA0RB : wsteps true true tm 5 (StB,([],S1,[S1;S0])) = Some (StC,([S1],S1,[S0])). Proof. reflexivity. Qed.
Lemma U_FINO_1RB1RD_0LC1RD_1RB1LC_1LA0RB : wsteps true false tm 7 (StB,([],S1,[S0])) = Some (StC,([S1],S1,[S0])). Proof. reflexivity. Qed.

(** ** Transported phases (framing = each unit's bl/br) *)
Lemma phP1_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall L R, csteps tm 1 (StC,(S1::L,S1,R)) = Some (StC,(L,S1,S1::R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_P1_1RB1RD_0LC1RD_1RB1LC_1LA0RB). Qed.
Lemma phRIP_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall k L R, csteps tm (2*k) (StC,(rep [S1;S1] k ++ L,S1,R)) = Some (StC,(L,S1,rep [S1;S1] k ++ R)).
Proof. intros. pose proof (cycL _ _ _ _ _ _ _ U_RIP_1RB1RD_0LC1RD_1RB1LC_1LA0RB k L R) as H; cbn [app] in H; exact H. Qed.
Lemma phSTPI_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall L R, csteps tm 2 (StC,(S0::L,S1,R)) = Some (StB,(S1::L,S1,R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_STPI_1RB1RD_0LC1RD_1RB1LC_1LA0RB). Qed.
Lemma phSTPO_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall R, csteps tm 3 (StC,([S1],S1,R)) = Some (StB,([S1],S1,S1::R)).
...
Lemma phFINI_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall L R, csteps tm 5 (StB,(L,S1,S1::S0::R)) = Some (StC,(S1::L,S1,S0::R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_FINI_1RB1RD_0LC1RD_1RB1LC_1LA0RB). Qed.
Lemma phFINO_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall L, csteps tm 7 (StB,(L,S1,[S0])) = Some (StC,(S1::L,S1,[S0])).
Proof. intros. exact (wsteps_frame_r _ _ _ _ _ _ _ _ _ _ L U_FINO_1RB1RD_0LC1RD_1RB1LC_1LA0RB). Qed.
...
Lemma ov_R_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall j, S1::rep [S1;S1] j ++ S1::[S0] = rep [S1;S1] (S j) ++ [S0].
Proof.
  induction j.
  - reflexivity.
...
Proof.
  ...
  - rewrite HIp, <- app_assoc.
    ...
    eapply csteps_chain. { apply phRIP_1RB1RD_0LC1RD_1RB1LC_1LA0RB. }
    ...
    apply phFINI_1RB1RD_0LC1RD_1RB1LC_1LA0RB.
...
Proof.
  intro p. destruct (lap_exact_1RB1RD_0LC1RD_1RB1LC_1LA0RB p) as (n & c' & Hr & Hc & Hn).
  exists n, c'. split; [exact Hr | split; [rewrite Hc; reflexivity | exact Hn]].
Qed.

Lemma boot_1RB1RD_0LC1RD_1RB1LC_1LA0RB : exists t0, stepn tm t0 InitES = Some (lift (Cc 2)).
Proof.
  exists 24.
...
Lemma reach_fino_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall p, exists k L, csteps tm k (Cc p) = Some (StB,(L,S1,[S0])).
Proof.
...
Lemma phVA_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall L, csteps tm 2 (StB,(L,S1,[S0])) = Some (StA,(L,S1,[S1])).
...
Lemma phVD_1RB1RD_0LC1RD_1RB1LC_1LA0RB : forall L, csteps tm 1 (StB,(L,S1,[S0])) = Some (StD,(S1::L,S0,[])).
Proof. intros. exact (wsteps_frame_r _ _ _ _ _ _ _ _ _ _ L
...
Proof.
  ...
  - (* StA : 2 steps into the overflow close *)
    destruct (reach_fino_1RB1RD_0LC1RD_1RB1LC_1LA0RB p) as (k & L & Hk).
    exists (k + 2). eexists. rewrite csteps_add, Hk.
    split; [apply phVA_1RB1RD_0LC1RD_1RB1LC_1LA0RB | reflexivity].
  ...
  - (* StD : 1 steps into the overflow close *)
    ...
    split; [apply phVD_1RB1RD_0LC1RD_1RB1LC_1LA0RB | reflexivity].
Qed.

Lemma nqhm_1RB1RD_0LC1RD_1RB1LC_1LA0RB : NeverQuasiHaltsSt tm.
Proof.
  apply (glue_neverqh tm Cc 2).
  - exact boot_1RB1RD_0LC1RD_1RB1LC_1LA0RB.
  - intros p _. apply lap_1RB1RD_0LC1RD_1RB1LC_1LA0RB.
  - intros p q _. apply vis_1RB1RD_0LC1RD_1RB1LC_1LA0RB.
Qed.

Theorem nqh_1RB1RD_0LC1RD_1RB1LC_1LA0RB : NeverQuasiHaltsSt tm_1RB1RD_0LC1RD_1RB1LC_1LA0RB.
Proof. exact nqhm_1RB1RD_0LC1RD_1RB1LC_1LA0RB. Qed.

Theorem nonhalt_1RB1RD_0LC1RD_1RB1LC_1LA0RB : NonHalt tm_1RB1RD_0LC1RD_1RB1LC_1LA0RB.
