(** * LAPC_1RB____1LC0LB_1RC1RD_0RD1LB: machine 1RB---_1LC0LB_1RC1RD_0RD1LB, boarded by CERTIFICATE.
...
Local Notation tm := tm_1RB____1LC0LB_1RC1RD_0RD1LB.
...
Lemma boot_1RB____1LC0LB_1RC1RD_0RD1LB : exists t0, stepn tm t0 InitES = Some (lift (Cc 1)).
Proof.
  exists 18.
...
Lemma viso_1RB____1LC0LB_1RC1RD_0RD1LB : forall (l : list lstep) (q : St),
  srun_st tm true true l B0_1RB____1LC0LB_1RC1RD_0RD1LB = Some q ->
  forall p j, cview p = (S j, None) ->
  exists k c, csteps tm k (Cc p) = Some c /\ fst c = q.
Proof.
  intros l q Hst p j E.
  apply (vis_of_run tm Cc true true l B0_1RB____1LC0LB_1RC1RD_0RD1LB p j [] []);
    [exact Hst | reflexivity | reflexivity | exact (gso_1RB____1LC0LB_1RC1RD_0RD1LB p j E)].
Qed.

Lemma vis_1RB____1LC0LB_1RC1RD_0RD1LB : forall p q, q <> StA -> exists k c, csteps tm k (Cc p) = Some c /\ fst c = q.
Proof.
  intros p q Hq.
  ...
  - (* StB *)
    apply (vis_via_ovf tm Cc Hi StB), viso_1RB____1LC0LB_1RC1RD_0RD1LB
      with (l := [SWin 3]).
    vm_compute; reflexivity.
  - (* StC *)
    apply (vis_via_ovf tm Cc Hi StC), viso_1RB____1LC0LB_1RC1RD_0RD1LB
      with (l := [SWin 4]).
    vm_compute; reflexivity.
...
Theorem iqh_1RB____1LC0LB_1RC1RD_0RD1LB : iqh tm.
Proof.
  destruct (glue_qh tm Cc 1 boot_1RB____1LC0LB_1RC1RD_0RD1LB (fun p _ => lap_1RB____1LC0LB_1RC1RD_0RD1LB p)
                    (fun p q _ Hq => vis_1RB____1LC0LB_1RC1RD_0RD1LB p q Hq)
...
Theorem nonhalt_1RB____1LC0LB_1RC1RD_0RD1LB : NonHalt tm.
Proof. apply (proj1 iqh_1RB____1LC0LB_1RC1RD_0RD1LB). Qed.
