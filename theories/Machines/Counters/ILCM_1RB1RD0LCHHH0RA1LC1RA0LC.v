...
Definition mk_1RB1RD0LCHHH0RA1LC1RA0LC (w : Sym) (d : Dir) (n : St) : option Trans :=
  Some (mkTrans w d n).

(** The machine 1RB1RD_0LC---_0RA1LC_1RA0LC. *)
Definition tm_1RB1RD0LCHHH0RA1LC1RA0LC : TM := fun q s => match q, s with
  | StA, S0 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S1 DR StB | StA, S1 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S1 DR StD
  | StB, S0 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S0 DL StC | StB, S1 => None
  | StC, S0 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S0 DR StA | StC, S1 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S1 DL StC
  | StD, S0 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S1 DR StA | StD, S1 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S0 DL StC end.

(** Its mirror 1LB1LD_0RC---_0LA1RC_1LA0RC: the same counter, grown leftward. *)
Definition tmm_1RB1RD0LCHHH0RA1LC1RA0LC : TM := fun q s => match q, s with
  | StA, S0 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S1 DL StB | StA, S1 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S1 DL StD
  | StB, S0 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S0 DR StC | StB, S1 => None
  | StC, S0 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S0 DL StA | StC, S1 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S1 DR StC
  | StD, S0 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S1 DL StA | StD, S1 => mk_1RB1RD0LCHHH0RA1LC1RA0LC S0 DR StC end.

Lemma mirror_ok_1RB1RD0LCHHH0RA1LC1RA0LC : mirror_tm tm_1RB1RD0LCHHH0RA1LC1RA0LC = tmm_1RB1RD0LCHHH0RA1LC1RA0LC.
Proof.
...
Lemma U_RIP_1RB1RD0LCHHH0RA1LC1RA0LC : wsteps true true tmm_1RB1RD0LCHHH0RA1LC1RA0LC 2 (StA,([S0;S1],S1,[]))
...
Lemma phP1_1RB1RD0LCHHH0RA1LC1RA0LC : forall L R,
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC 1 (StC,(S1::L,S0,R)) = Some (StA,(L,S1,S0::R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_P1_1RB1RD0LCHHH0RA1LC1RA0LC). Qed.
Lemma phRIP_1RB1RD0LCHHH0RA1LC1RA0LC : forall k L R,
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC (2*k) (StA,(rep [S0;S1] k ++ L,S1,R))
  = Some (StA,(L,S1,rep [S1;S1] k ++ R)).
Proof. intros. pose proof (cycL _ _ _ _ _ _ _ U_RIP_1RB1RD0LCHHH0RA1LC1RA0LC k L R) as H;
  cbn [app] in H; exact H. Qed.
Lemma phSTPI_1RB1RD0LCHHH0RA1LC1RA0LC : forall L R,
...
Proof. intros. exact (cycR _ _ _ _ _ _ U_RET_1RB1RD0LCHHH0RA1LC1RA0LC k L R). Qed.
Lemma phFIN_1RB1RD0LCHHH0RA1LC1RA0LC : forall L R,
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC 1 (StC,(L,S1,S0::R)) = Some (StC,(S1::L,S0,R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_FIN_1RB1RD0LCHHH0RA1LC1RA0LC). Qed.

(** The exact lap: from the anchor at p to the anchor at p+1. *)
Lemma lap_exact_1RB1RD0LCHHH0RA1LC1RA0LC : forall p, exists n c',
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC n (Cc_1RB1RD0LCHHH0RA1LC1RA0LC p) = Some c' /\ c' = Cc_1RB1RD0LCHHH0RA1LC1RA0LC (Pos.succ p) /\ 0 < n.
Proof.
  intros p. pose proof (Pos2Nat.is_pos p) as Hpos.
  destruct (cview p) as [j oq] eqn:Ecv. unfold Cc_1RB1RD0LCHHH0RA1LC1RA0LC.
  destruct oq as [q0|].
  - destruct (cview_some_J p j q0 Ecv) as (HJp & HJs).
    ...
    + rewrite HJp, <- app_assoc.
      ...
      eapply csteps_chain. { apply phP1_1RB1RD0LCHHH0RA1LC1RA0LC. }
      eapply csteps_chain. { apply phRIP_1RB1RD0LCHHH0RA1LC1RA0LC. }
      rewrite Hiq.
      eapply csteps_chain. { apply phSTPI_1RB1RD0LCHHH0RA1LC1RA0LC. }
      rewrite rep_dbl.
  ...
  - destruct j as [|j'].
    ...
    + rewrite HJp, pair_rot.
      eapply csteps_chain. { apply phP1_1RB1RD0LCHHH0RA1LC1RA0LC. }
      eapply csteps_chain. { apply phRIP_1RB1RD0LCHHH0RA1LC1RA0LC. }
      eapply csteps_chain. { apply phSTPO_1RB1RD0LCHHH0RA1LC1RA0LC. }
...
Lemma lap_1RB1RD0LCHHH0RA1LC1RA0LC : forall p, exists n c',
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC n (Cc_1RB1RD0LCHHH0RA1LC1RA0LC p) = Some c' /\
  lift c' = lift (Cc_1RB1RD0LCHHH0RA1LC1RA0LC (Pos.succ p)) /\ 0 < n.
Proof.
  intro p. destruct (lap_exact_1RB1RD0LCHHH0RA1LC1RA0LC p) as (n & c' & Hr & Hc & Hn).
  exists n, c'. split; [exact Hr | split; [rewrite Hc; reflexivity | exact Hn]].
Qed.

Lemma boot_1RB1RD0LCHHH0RA1LC1RA0LC : exists t0, stepn tmm_1RB1RD0LCHHH0RA1LC1RA0LC t0 InitES = Some (lift (Cc_1RB1RD0LCHHH0RA1LC1RA0LC 1)).
Proof.
  exists 3.
  assert (H : match csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC 3 c0 with
              | Some c => ceqb c (Cc_1RB1RD0LCHHH0RA1LC1RA0LC 1) | None => false end = true)
    by (vm_compute; reflexivity).
  destruct (csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC 3 c0) as [c|] eqn:E; [|discriminate].
...
Lemma U_VAB_1RB1RD0LCHHH0RA1LC1RA0LC : wsteps false true tmm_1RB1RD0LCHHH0RA1LC1RA0LC 3 (StA,([S0],S1,[]))
  = Some (StB,([],S0,[S1; S1; S1])). Proof. reflexivity. Qed.
Lemma phVAB_1RB1RD0LCHHH0RA1LC1RA0LC : forall R,
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC 3 (StA,([S0],S1,R)) = Some (StB,([],S0,S1 :: S1 :: S1 :: R)).
Proof. intros. exact (wsteps_frame_l _ _ _ _ _ _ _ _ _ _ R U_VAB_1RB1RD0LCHHH0RA1LC1RA0LC). Qed.

Lemma visB_1RB1RD0LCHHH0RA1LC1RA0LC : forall p, exists k c,
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC k (Cc_1RB1RD0LCHHH0RA1LC1RA0LC p) = Some c /\ fst c = StB.
Proof.
  ...
  - assert (Hnz : tovf p <> 0).
    ...
    destruct (lap_exact_1RB1RD0LCHHH0RA1LC1RA0LC p) as (n & c' & Hrun & Hc' & _). subst c'.
  ...
  - destruct j as [|j'].
    ...
    unfold Cc_1RB1RD0LCHHH0RA1LC1RA0LC. eexists. eexists. split.
    * rewrite HJp, pair_rot.
      eapply csteps_chain. { apply phP1_1RB1RD0LCHHH0RA1LC1RA0LC. }
      eapply csteps_chain. { apply phRIP_1RB1RD0LCHHH0RA1LC1RA0LC. }
      apply phVAB_1RB1RD0LCHHH0RA1LC1RA0LC.
    * reflexivity.
Qed.

(* --- determined prefixes from the anchor --- *)
Lemma phVA_1RB1RD0LCHHH0RA1LC1RA0LC : forall L,
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC 1 (StC,(S1::L,S0,[]))
  = Some (StA,(L,S1,[S0])).
Proof. reflexivity. Qed.

Lemma phVD_1RB1RD0LCHHH0RA1LC1RA0LC : forall x L,
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC 2 (StC,(S1::x::L,S0,[]))
  = Some (StD,(L,x,[S1; S0])).
Proof. reflexivity. Qed.

Lemma vis_1RB1RD0LCHHH0RA1LC1RA0LC : forall p q, exists k c,
  csteps tmm_1RB1RD0LCHHH0RA1LC1RA0LC k (Cc_1RB1RD0LCHHH0RA1LC1RA0LC p) = Some c /\ fst c = q.
Proof.
  intros p q. destruct (Jp_head p) as (w & Hw). unfold Cc_1RB1RD0LCHHH0RA1LC1RA0LC. destruct q.
  - exists 1. eexists. rewrite Hw.
    split; [apply phVA_1RB1RD0LCHHH0RA1LC1RA0LC | reflexivity].
  - apply (visB_1RB1RD0LCHHH0RA1LC1RA0LC p).
  ...
  - rewrite Hw. destruct w as [|x w'].
    ...
    + exists 2. eexists. split.
      * change ((S1 :: x :: w') ++ [S0])
          with (S1 :: x :: (w' ++ [S0])). apply phVD_1RB1RD0LCHHH0RA1LC1RA0LC.
      * reflexivity.
Qed.

Lemma nqhm_1RB1RD0LCHHH0RA1LC1RA0LC : NeverQuasiHaltsSt tmm_1RB1RD0LCHHH0RA1LC1RA0LC.
Proof.
  apply (glue_neverqh tmm_1RB1RD0LCHHH0RA1LC1RA0LC Cc_1RB1RD0LCHHH0RA1LC1RA0LC 1).
  - exact boot_1RB1RD0LCHHH0RA1LC1RA0LC.
  - intros p _. apply lap_1RB1RD0LCHHH0RA1LC1RA0LC.
  - intros p q _. apply vis_1RB1RD0LCHHH0RA1LC1RA0LC.
Qed.
