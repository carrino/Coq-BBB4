(** * BNC_1RB____1LC1RD_1LB1RD_1LB0RD: machine 1RB---_1LC1RD_1LB1RD_1LB0RD quasihalts, with bound 1.

    One of the three [1RB---] rows of the residue's `no anchor` bucket.
    [StA]'s [S1] transition is undefined, so [StA] fires once -- at
    configuration index 0 -- and [StD], [StB], [StC] are CLOSED
    ...
    writing zeros; [StB] and [StC] sweep back left over the zeros
...
Definition tm_1RB____1LC1RD_1LB1RD_1LB0RD : TM := fun q s => match q, s with
...
Lemma boot_1RB____1LC1RD_1LB1RD_1LB0RD : exists t0,
  stepn tm_1RB____1LC1RD_1LB1RD_1LB0RD t0 InitES = Some (lift (Cb StD 1)).
Proof.
  exists 4.
  assert (H : match csteps tm_1RB____1LC1RD_1LB1RD_1LB0RD 4 c0 with
              | Some c => ceqb c (Cb StD 1)
              | None => false
              end = true) by (vm_compute; reflexivity).
  destruct (csteps tm_1RB____1LC1RD_1LB1RD_1LB0RD 4 c0) as [c|] eqn:Eq; [|discriminate].
...
(** 1RB---_1LC1RD_1LB1RD_1LB0RD: never halts, quasihalts, and every quiet state made its last
    visit by index 1. *)
Theorem iqh_1RB____1LC1RD_1LB1RD_1LB0RD : iqh tm_1RB____1LC1RD_1LB1RD_1LB0RD.
Proof.
  apply (bounce_qh tm_1RB____1LC1RD_1LB1RD_1LB0RD StD StB StC
           eq_refl eq_refl eq_refl eq_refl eq_refl eq_refl
           boot_1RB____1LC1RD_1LB1RD_1LB0RD
