(** * KA_1RB____0LC1RD_0LB1RD_1LB0RD: 1RB---_0LC1RD_0LB1RD_1LB0RD boards as [iqh].
    ...
    with roles [qD = StD], [qA = StB], [qB = StC], so the whole board is
    that closer plus five [vm_compute] facts.

    Read at [(qD, ([S1], S0, Kp p))] the lap is [2j + 6] in the carry length
    [j], affine on both branches; the return sweep alternates [StB]/[StC],
...
Definition tm_1RB____0LC1RD_0LB1RD_1LB0RD : TM := fun q s => match q, s with
...
Local Notation tm := tm_1RB____0LC1RD_0LB1RD_1LB0RD.

Lemma boot_1RB____0LC1RD_0LB1RD_1LB0RD :
...
Lemma bq_1RB____0LC1RD_0LB1RD_1LB0RD : forall n c, 0 < n < 9 ->
...
Theorem iqh_1RB____0LC1RD_0LB1RD_1LB0RD : iqh tm.
Proof.
  exact (KpWallAlt.kpwallalt_qh tm StD StB StC 9 1
           eq_refl eq_refl eq_refl eq_refl eq_refl eq_refl
           ltac:(intro q; destruct q; auto)
           ltac:(discriminate) ltac:(discriminate) ltac:(discriminate)
           ltac:(vm_compute; reflexivity)
           boot_1RB____0LC1RD_0LB1RD_1LB0RD bq_1RB____0LC1RD_0LB1RD_1LB0RD).
Qed.

Theorem nonhalt_1RB____0LC1RD_0LB1RD_1LB0RD : NonHalt tm.
Proof. apply (proj1 iqh_1RB____0LC1RD_0LB1RD_1LB0RD). Qed.
