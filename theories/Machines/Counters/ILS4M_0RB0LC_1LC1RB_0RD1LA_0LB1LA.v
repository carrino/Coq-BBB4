(** * ILS4_0RB0LC_1LC1RB_0RD1LA_0LB1LA: 2-phase [Ip] interleaved binary counter, machine
    0RB0LC_1LC1RB_0RD1LA_0LB1LA (lap-shape rank 4, `-DA|+AB`, of tools/counter_lapshapes.tsv).
...
Lemma U_P1_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps true true tm 1 (StA,([S1],S0,[])) = Some (StB,([],S1,[S0])). Proof. reflexivity. Qed.
Lemma U_RIP_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps true true tm 1 (StB,([S1],S1,[])) = Some (StB,([],S1,[S1])). Proof. reflexivity. Qed.
Lemma U_STPI_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps true true tm 1 (StB,([S0],S1,[])) = Some (StB,([],S0,[S1])). Proof. reflexivity. Qed.
Lemma U_TRN_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps true true tm 1 (StB,([],S0,[S1])) = Some (StC,([S1],S1,[])). Proof. reflexivity. Qed.
Lemma U_RET_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps true true tm 2 (StC,([],S1,[S1;S1])) = Some (StC,([S0;S1],S1,[])). Proof. reflexivity. Qed.
Lemma U_FIN_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps true true tm 1 (StC,([],S1,[S0])) = Some (StA,([S1],S0,[])). Proof. reflexivity. Qed.
Lemma U_STPO_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps false true tm 3 (StB,([S1;S0],S1,[])) = Some (StC,([S1],S1,[S1])). Proof. reflexivity. Qed.
Lemma U_FIN2_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps true false tm 7 (StC,([],S1,[S1;S0])) = Some (StA,([S1;S0;S1],S0,[])). Proof. reflexivity. Qed.
Lemma U_VZ_0RB0LC_1LC1RB_0RD1LA_0LB1LA : wsteps true false tm 3 (StC,([],S1,[S1;S0])) = Some (StD,([S1],S0,[S0])). Proof. reflexivity. Qed.

(** ** Transported phases (framing = each unit's bl/br) *)
Lemma phP1_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall L R, csteps tm 1 (StA,(S1::L,S0,R)) = Some (StB,(L,S1,S0::R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_P1_0RB0LC_1LC1RB_0RD1LA_0LB1LA). Qed.
Lemma phRIP_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall k L R, csteps tm (1*k) (StB,(rep [S1] k ++ L,S1,R)) = Some (StB,(L,S1,rep [S1] k ++ R)).
Proof. intros. pose proof (cycL _ _ _ _ _ _ _ U_RIP_0RB0LC_1LC1RB_0RD1LA_0LB1LA k L R) as H; cbn [app] in H; exact H. Qed.
Lemma phSTPI_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall L R, csteps tm 1 (StB,(S0::L,S1,R)) = Some (StB,(L,S0,S1::R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_STPI_0RB0LC_1LC1RB_0RD1LA_0LB1LA). Qed.
Lemma phTRN_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall L R, csteps tm 1 (StB,(L,S0,S1::R)) = Some (StC,(S1::L,S1,R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_TRN_0RB0LC_1LC1RB_0RD1LA_0LB1LA). Qed.
Lemma phRET_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall k L R, csteps tm (2*k) (StC,(L,S1,rep [S1;S1] k ++ R)) = Some (StC,(rep [S0;S1] k ++ L,S1,R)).
Proof. intros. exact (cycR _ _ _ _ _ _ U_RET_0RB0LC_1LC1RB_0RD1LA_0LB1LA k L R). Qed.
Lemma phFIN_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall L R, csteps tm 1 (StC,(L,S1,S0::R)) = Some (StA,(S1::L,S0,R)).
Proof. intros. exact (wsteps_frame _ _ _ _ _ _ _ _ _ _ L R U_FIN_0RB0LC_1LC1RB_0RD1LA_0LB1LA). Qed.
Lemma phSTPO_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall R, csteps tm 3 (StB,([S1;S0],S1,R)) = Some (StC,([S1],S1,S1::R)).
Proof. intros. exact (wsteps_frame_l _ _ _ _ _ _ _ _ _ _ R U_STPO_0RB0LC_1LC1RB_0RD1LA_0LB1LA). Qed.
Lemma phFIN2_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall L, csteps tm 7 (StC,(L,S1,[S1;S0])) = Some (StA,(S1::S0::S1::L,S0,[])).
Proof. intros. exact (wsteps_frame_r _ _ _ _ _ _ _ _ _ _ L U_FIN2_0RB0LC_1LC1RB_0RD1LA_0LB1LA). Qed.
Lemma phVZ_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall L, csteps tm 3 (StC,(L,S1,[S1;S0])) = Some (StD,(S1::L,S0,[S0])).
Proof. intros. exact (wsteps_frame_r _ _ _ _ _ _ _ _ _ _ L U_VZ_0RB0LC_1LC1RB_0RD1LA_0LB1LA). Qed.

(** ** The lap

    Interior branch: EXACT (the next anchor on the nose) -- the deep-visit
    induction below chains on this equality. *)
Lemma lap_int_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall p j q0, cview p = (j, Some q0) ->
  exists n c', csteps tm n (Cc p) = Some c' /\ c' = Cc (Pos.succ p) /\ 0 < n.
Proof.
  intros p j q0 Ecv. unfold Cc_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
  destruct (cview_some_I p j q0 Ecv) as (HIp & HIs).
  do 2 eexists. split; [|split].
  + rewrite HIp, <- app_assoc. cbn [app].
    rewrite rep_dbl, <- rep_slide.
    eapply csteps_chain. { apply phP1_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    eapply csteps_chain. { apply phRIP_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    eapply csteps_chain. { apply phSTPI_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    eapply csteps_chain. { apply phTRN_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    rewrite <- rep_dbl.
    eapply csteps_chain. { apply (phRET_0RB0LC_1LC1RB_0RD1LA_0LB1LA j). }
    apply phFIN_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
...
Lemma lift_lblank_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall q l h r, lift (q,(l ++ [S0],h,r)) = lift (q,(l,h,r)).
...
Lemma closeO_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall (l : list Sym) q h r,
  lift (q,(l ++ [S1],h,r)) = lift (q,(l ++ [S1;S0],h,r)).
Proof.
  intros.
  replace (l ++ [S1;S0]) with ((l ++ [S1]) ++ [S0])
    by (rewrite <- app_assoc; reflexivity).
  rewrite lift_lblank_0RB0LC_1LC1RB_0RD1LA_0LB1LA. reflexivity.
Qed.

Lemma lap_ov_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall p j', cview p = (S j', None) ->
  exists n c', csteps tm n (Cc p) = Some c' /\ lift c' = lift (Cc (Pos.succ p)) /\ 0 < n.
Proof.
  intros p j' Ecv. unfold Cc_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
  ...
  + rewrite HIp, <- app_assoc. cbn [app].
    ...
    eapply csteps_chain. { apply phP1_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    eapply csteps_chain. { apply phRIP_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    eapply csteps_chain. { apply phSTPO_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    rewrite rep_slide, <- rep_dbl.
    eapply csteps_chain. { apply (phRET_0RB0LC_1LC1RB_0RD1LA_0LB1LA j'). }
    apply phFIN2_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
  + rewrite HIs, <- app_assoc. cbn [app].
    change (rep [S1;S0] (S j') ++ S1 :: S1::S0::[])
      with (rep [S1;S0] (S j') ++ [S1] ++ [S1;S0]).
    rewrite app_assoc, pair_rot.
    apply (closeO_0RB0LC_1LC1RB_0RD1LA_0LB1LA (S1::S0::S1::rep [S0;S1] j')).
  + lia.
Qed.

Lemma lap_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall p, exists n c', csteps tm n (Cc p) = Some c' /\ lift c' = lift (Cc (Pos.succ p)) /\ 0 < n.
Proof.
  intro p. destruct (cview p) as [j oq] eqn:Ecv. destruct oq as [q0|].
  - destruct (lap_int_0RB0LC_1LC1RB_0RD1LA_0LB1LA p j q0 Ecv) as (n & c' & H1 & H2 & H3).
  ...
  - destruct j as [|j'].
    ...
    exact (lap_ov_0RB0LC_1LC1RB_0RD1LA_0LB1LA p j' Ecv).
Qed.
...
Lemma reach_fin2_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall p, exists k L, csteps tm k (Cc p) = Some (StC,(L,S1,[S1;S0])).
Proof.
  ...
  - assert (Hnz : tovf p <> 0).
    ...
    destruct (lap_int_0RB0LC_1LC1RB_0RD1LA_0LB1LA p j q0 Ecv) as (n & c' & Hrun & Hc' & _). subst c'.
  ...
  - destruct j as [|j'].
    ...
    unfold Cc_0RB0LC_1LC1RB_0RD1LA_0LB1LA. eexists. eexists.
    rewrite HIp, <- app_assoc. cbn [app].
    rewrite rep_dbl, <- rep_slide.
    eapply csteps_chain. { apply phP1_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    eapply csteps_chain. { apply phRIP_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    eapply csteps_chain. { apply phSTPO_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
    rewrite rep_slide, <- rep_dbl.
    apply (phRET_0RB0LC_1LC1RB_0RD1LA_0LB1LA j').
Qed.

Lemma vis_Z_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall p, exists k c, csteps tm k (Cc p) = Some c /\ fst c = StD.
Proof.
  intro p. destruct (reach_fin2_0RB0LC_1LC1RB_0RD1LA_0LB1LA p) as (k & L & Hk).
  exists (k + 3). eexists. rewrite csteps_add, Hk. split.
  - apply phVZ_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
  - reflexivity.
Qed.

(** StC is entered by TRN (interior) and by the overflow stop, so every
    lap visits it. *)
Lemma vis_R_0RB0LC_1LC1RB_0RD1LA_0LB1LA : forall p, exists k c, csteps tm k (Cc p) = Some c /\ fst c = StC.
Proof.
  intro p. destruct (cview p) as [j oq] eqn:Ecv. destruct oq as [q0|].
  - destruct (cview_some_I p j q0 Ecv) as (HIp & _).
    unfold Cc_0RB0LC_1LC1RB_0RD1LA_0LB1LA. eexists. eexists. split.
    + rewrite HIp, <- app_assoc. cbn [app].
      rewrite rep_dbl, <- rep_slide.
      eapply csteps_chain. { apply phP1_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
      eapply csteps_chain. { apply phRIP_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
      eapply csteps_chain. { apply phSTPI_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
      apply phTRN_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
    + reflexivity.
  - destruct j as [|j'].
    { exfalso. destruct p; simpl in Ecv; [destruct (cview p); discriminate|discriminate|discriminate]. }
    destruct (cview_none_I p j' Ecv) as (HIp & _).
    ...
    + rewrite HIp, <- app_assoc. cbn [app].
      ...
      eapply csteps_chain. { apply phP1_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
      eapply csteps_chain. { apply phRIP_0RB0LC_1LC1RB_0RD1LA_0LB1LA. }
      apply phSTPO_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
    + reflexivity.
Qed.
...
Proof.
  ...
  - (* StB : 1 step from the anchor (P1) *)
    destruct (Ip_head p) as (w & Hw). unfold Cc_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
    rewrite Hw. cbn [app]. exists 1. eexists. split.
    + apply phP1_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
    + reflexivity.
  - apply vis_R_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
  - apply vis_Z_0RB0LC_1LC1RB_0RD1LA_0LB1LA.
Qed.
