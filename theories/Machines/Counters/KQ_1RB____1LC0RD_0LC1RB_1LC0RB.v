(** * KQ_1RB____1LC0RD_0LC1RB_1LC0RB: 1RB---_1LC0RD_0LC1RB_1LC0RB boards as [iqh].
    ...
    roles [qW = StC], [qR1 = StB], [qR2 = StD], so the whole board is that
...
Definition tm_1RB____1LC0RD_0LC1RB_1LC0RB : TM := fun q s => match q, s with
...
Local Notation tm := tm_1RB____1LC0RD_0LC1RB_1LC0RB.

Lemma boot_1RB____1LC0RD_0LC1RB_1LC0RB : stepn tm 2 InitES = Some (lift (StC, ([], S1, Kp 1))).
Proof.
...
Lemma bq_1RB____1LC0RD_0LC1RB_1LC0RB : forall n c, 0 < n < 2 ->
...
Theorem iqh_1RB____1LC0RD_0LC1RB_1LC0RB : iqh tm.
Proof.
  exact (KpWallQH.kpwall_qh tm StC StB StD 2
           eq_refl eq_refl eq_refl eq_refl eq_refl eq_refl
           ltac:(intro q; destruct q; auto)
           ltac:(discriminate) ltac:(discriminate) ltac:(discriminate)
           ltac:(vm_compute; reflexivity)
           boot_1RB____1LC0RD_0LC1RB_1LC0RB bq_1RB____1LC0RD_0LC1RB_1LC0RB).
Qed.
