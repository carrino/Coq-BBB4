(** * KS_1RB____0LC1RB_0LB1RD_1LC0RD: 1RB---_0LC1RB_0LB1RD_1LC0RD boards as [iqh].
    ...
    with roles [qR = StD], [qQ = StC], [qP = StB], so the whole board is
    ...
    [StC]/[StB] and the two do NOT agree at the wall, which is why this
...
Definition tm_1RB____0LC1RB_0LB1RD_1LC0RD : TM := fun q s => match q, s with
...
Local Notation tm := tm_1RB____0LC1RB_0LB1RD_1LC0RD.

Lemma boot_1RB____0LC1RB_0LB1RD_1LC0RD :
  stepn tm 4 InitES = Some (lift (StC, ([], S1, Kp 1))).
Proof.
...
Lemma bq_1RB____0LC1RB_0LB1RD_1LC0RD : forall n c, 0 < n < 4 ->
...
Theorem iqh_1RB____0LC1RB_0LB1RD_1LC0RD : iqh tm.
Proof.
  exact (KpWallScan.kpwallscan_qh tm StD StC StB 4 1
           eq_refl eq_refl eq_refl eq_refl eq_refl eq_refl
           ltac:(intro q; destruct q; auto)
           ltac:(discriminate) ltac:(discriminate) ltac:(discriminate)
           ltac:(vm_compute; reflexivity)
           boot_1RB____0LC1RB_0LB1RD_1LC0RD bq_1RB____0LC1RB_0LB1RD_1LC0RD).
Qed.

Theorem nonhalt_1RB____0LC1RB_0LB1RD_1LC0RD : NonHalt tm.
Proof. apply (proj1 iqh_1RB____0LC1RB_0LB1RD_1LC0RD). Qed.
