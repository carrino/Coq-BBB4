(** * IRules.Meta: the certificate checker and the meta-cycle induction.
    ...
    Validation: all 428 v1 certificates in the BBB harness's
    results/certs_irules verify through this checker (428/428 true;
    sweep generated by tools/gen_irules.py --sweep, one coqtop per
    certificate, fuel 300000, 3-13 s each dominated by the anchor
    re-simulation). *)

From Coq Require Import Arith ZArith Lia Bool List Setoid.
From BBB4 Require Import BBB4_Statement CTape.
From BBB4.Checkers Require Import Cycle.
From BBB4.Checkers.IRules Require Import Expr RLE Engine Rules AnchorVisits.
